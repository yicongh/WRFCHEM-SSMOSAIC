   ...
   integer ns
      ...
      do i = its, ite
        do isize = 1, nbin_o
          ...
          if (totoa_a09(i,k,j) .gt. 1.0e-12 .and. isize .eq. 9) mass_oc=totoa_a09(i,k,j)*conv1a  
          if (totoa_a10(i,k,j) .gt. 1.0e-12 .and. isize .eq. 10) mass_oc=totoa_a10(i,k,j)*conv1a
          if (totoa_a11(i,k,j) .gt. 1.0e-12 .and. isize .eq. 11) mass_oc=totoa_a11(i,k,j)*conv1a
          if (totoa_a12(i,k,j) .gt. 1.0e-12 .and. isize .eq. 12) mass_oc=totoa_a12(i,k,j)*conv1a
          if (totoa_a13(i,k,j) .gt. 1.0e-12 .and. isize .eq. 13) mass_oc=totoa_a13(i,k,j)*conv1a
          if (totoa_a14(i,k,j) .gt. 1.0e-12 .and. isize .eq. 14) mass_oc=totoa_a14(i,k,j)*conv1a
          if (totoa_a15(i,k,j) .gt. 1.0e-12 .and. isize .eq. 15) mass_oc=totoa_a15(i,k,j)*conv1a
          if (totoa_a16(i,k,j) .gt. 1.0e-12 .and. isize .eq. 16) mass_oc=totoa_a16(i,k,j)*conv1a
          if (totoa_a17(i,k,j) .gt. 1.0e-12 .and. isize .eq. 17) mass_oc=totoa_a17(i,k,j)*conv1a
          if (totoa_a18(i,k,j) .gt. 1.0e-12 .and. isize .eq. 18) mass_oc=totoa_a18(i,k,j)*conv1a
          if (totoa_a19(i,k,j) .gt. 1.0e-12 .and. isize .eq. 19) mass_oc=totoa_a19(i,k,j)*conv1a
          if (totoa_a20(i,k,j) .gt. 1.0e-12 .and. isize .eq. 20) mass_oc=totoa_a20(i,k,j)*conv1a
