   ...
   subroutine sum_pm_mosaic_iepox_vbs (                                      &
         alt, chem,                                                    &
         pm2_5_dry, pm2_5_water, pm2_5_dry_ec, pm10,                   &
         ids,ide, jds,jde, kds,kde,                                    &
         ims,ime, jms,jme, kms,kme,                                    &
            ...
            do k=kts,kmax
               do i=its,imax
                  mass = chem(i,k,j,lptr_so4_aer(n,itype,iphase)) &
                       ...
                       + chem(i,k,j,lptr_opcg6_b_o_aer(n,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg7_b_o_aer(n,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg8_b_o_aer(n,itype,iphase)) &
                       + chem(i,k,j,lptr_biog1_c_aer(n,itype,iphase))    &
                       + chem(i,k,j,lptr_biog2_c_aer(n,itype,iphase))    &
                       + chem(i,k,j,lptr_biog3_c_aer(n,itype,iphase))    &
                       + chem(i,k,j,lptr_biog4_c_aer(n,itype,iphase))    &
                       ...
                       + chem(i,k,j,lptr_ant2_o_aer(n,itype,iphase))    &
                       + chem(i,k,j,lptr_ant3_o_aer(n,itype,iphase))    &
                       + chem(i,k,j,lptr_iepox_aer(n,itype,iphase))    &
                       + chem(i,k,j,lptr_iepoxos_aer(n,itype,iphase))    &
                       + chem(i,k,j,lptr_tetrol_aer(n,itype,iphase))    &
                       + chem(i,k,j,lptr_cldiepoxos_aer(n,itype,iphase))    &
                       + chem(i,k,j,lptr_cldtetrol_aer(n,itype,iphase))    &
                       + chem(i,k,j,lptr_gly_aer(n,itype,iphase))    
   ...
   end subroutine sum_pm_mosaic_iepox_vbs
   ...
   enddo 
      ...
      subroutine sum_iepox_vbs (aero_diag_opt,                         &
             alt, chem,                                                &
             hoa_a01,hoa_a02,hoa_a03,hoa_a04,                          &
             bboa_a01,bboa_a02,bboa_a03,bboa_a04,                      &
             soa_a01,soa_a02,soa_a03,soa_a04,                          &
   ...
   do itype=1,ntype_aer
         ...
         totoa_a01(i,k,j)= chem(i,k,j,lptr_pcg1_b_c_aer(1,itype,iphase)) &
                       ...
                       + chem(i,k,j,lptr_opcg8_b_o_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_biog1_c_aer(1,itype,iphase)) &
                       ...
                       + chem(i,k,j,lptr_iepox_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_iepoxos_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_tetrol_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_cldiepoxos_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_cldtetrol_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_gly_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_oc_aer(1,itype,iphase))
         ...
         totoa_a02(i,k,j)= chem(i,k,j,lptr_pcg1_b_c_aer(2,itype,iphase)) &
                       ...
                       + chem(i,k,j,lptr_opcg8_b_o_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_biog1_c_aer(2,itype,iphase)) &
                       ...
                       + chem(i,k,j,lptr_iepox_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_iepoxos_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_tetrol_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_cldiepoxos_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_cldtetrol_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_gly_aer(2,itype,iphase)) &
                       +  chem(i,k,j,lptr_oc_aer(2,itype,iphase))
         ...
         totoa_a03(i,k,j)= chem(i,k,j,lptr_pcg1_b_c_aer(3,itype,iphase)) &
                       ...
                       + chem(i,k,j,lptr_opcg8_b_o_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_biog1_c_aer(3,itype,iphase)) &
                       ...
                       + chem(i,k,j,lptr_iepox_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_iepoxos_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_tetrol_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_cldiepoxos_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_cldtetrol_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_gly_aer(3,itype,iphase)) &
                       +  chem(i,k,j,lptr_oc_aer(3,itype,iphase))
         ...
         totoa_a04(i,k,j)= chem(i,k,j,lptr_pcg1_b_c_aer(4,itype,iphase)) &
                       ...
                       + chem(i,k,j,lptr_opcg8_b_o_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_biog1_c_aer(4,itype,iphase)) &
                       ...
                       + chem(i,k,j,lptr_iepox_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_iepoxos_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_tetrol_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_cldiepoxos_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_cldtetrol_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_gly_aer(4,itype,iphase)) &
                       +  chem(i,k,j,lptr_oc_aer(4,itype,iphase))
   ...
   do itype=1,ntype_aer
         ...
         soa_a01(i,k,j)= chem(i,k,j,lptr_opcg2_f_o_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg3_f_o_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg4_f_o_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg5_f_o_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg6_f_o_aer(1,itype,iphase)) &
        ...
        arosoa_a01(i,k,j)= chem(i,k,j,lptr_biog1_c_aer(1,itype,iphase))    &
                       + chem(i,k,j,lptr_biog2_c_aer(1,itype,iphase))      &
                       + chem(i,k,j,lptr_biog3_c_aer(1,itype,iphase))      &
                       + chem(i,k,j,lptr_biog4_c_aer(1,itype,iphase))      &
                       + chem(i,k,j,lptr_ant2_o_aer(1,itype,iphase))      &
        ...
        biog_a01(i,k,j)= chem(i,k,j,lptr_ant1_c_aer(1,itype,iphase))    &
                       + chem(i,k,j,lptr_ant2_c_aer(1,itype,iphase))    &
                       + chem(i,k,j,lptr_ant3_c_aer(1,itype,iphase))    &
                       + chem(i,k,j,lptr_ant4_c_aer(1,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_o_aer(1,itype,iphase))    &
          ...
          hsoa_a01(i,k,j)=  chem(i,k,j,lptr_opcg2_f_o_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg3_f_o_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg4_f_o_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg5_f_o_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg6_f_o_aer(1,itype,iphase)) 

          bbsoa_a01(i,k,j)=chem(i,k,j,lptr_opcg1_b_o_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg2_b_o_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg3_b_o_aer(1,itype,iphase)) & 
                       + chem(i,k,j,lptr_opcg4_b_o_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg5_b_o_aer(1,itype,iphase)) &
   ...
   do itype=1,ntype_aer
         ...
         soa_a02(i,k,j)= chem(i,k,j,lptr_opcg2_f_o_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg3_f_o_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg4_f_o_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg5_f_o_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg6_f_o_aer(2,itype,iphase)) &
        ...
        arosoa_a02(i,k,j)= chem(i,k,j,lptr_biog1_c_aer(2,itype,iphase))    &
                       + chem(i,k,j,lptr_biog2_c_aer(2,itype,iphase))      &
                       + chem(i,k,j,lptr_biog3_c_aer(2,itype,iphase))      &
                       + chem(i,k,j,lptr_biog4_c_aer(2,itype,iphase))      &
                       + chem(i,k,j,lptr_ant2_o_aer(2,itype,iphase))      &
        ...
        biog_a02(i,k,j)= chem(i,k,j,lptr_ant1_c_aer(2,itype,iphase))    &
                       + chem(i,k,j,lptr_ant2_c_aer(2,itype,iphase))    &
                       + chem(i,k,j,lptr_ant3_c_aer(2,itype,iphase))    &
                       + chem(i,k,j,lptr_ant4_c_aer(2,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_o_aer(2,itype,iphase))    &
          ...
          hsoa_a02(i,k,j)=  chem(i,k,j,lptr_opcg2_f_o_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg3_f_o_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg4_f_o_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg5_f_o_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg6_f_o_aer(2,itype,iphase))

          bbsoa_a02(i,k,j)= chem(i,k,j,lptr_opcg1_b_o_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg2_b_o_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg3_b_o_aer(2,itype,iphase)) &
                       +chem(i,k,j,lptr_opcg4_b_o_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg5_b_o_aer(2,itype,iphase)) &
   ...
   do itype=1,ntype_aer
         ...
         soa_a03(i,k,j)= chem(i,k,j,lptr_opcg2_f_o_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg3_f_o_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg4_f_o_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg5_f_o_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg6_f_o_aer(3,itype,iphase)) &
        ...
        arosoa_a03(i,k,j)= chem(i,k,j,lptr_biog1_c_aer(3,itype,iphase))    &
                       + chem(i,k,j,lptr_biog2_c_aer(3,itype,iphase))      &
                       + chem(i,k,j,lptr_biog3_c_aer(3,itype,iphase))      &
                       + chem(i,k,j,lptr_biog4_c_aer(3,itype,iphase))      &
                       + chem(i,k,j,lptr_ant2_o_aer(3,itype,iphase))      &
        ...
        biog_a03(i,k,j)= chem(i,k,j,lptr_ant1_c_aer(3,itype,iphase))    &
                       + chem(i,k,j,lptr_ant2_c_aer(3,itype,iphase))    &
                       + chem(i,k,j,lptr_ant3_c_aer(3,itype,iphase))    &
                       + chem(i,k,j,lptr_ant4_c_aer(3,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_o_aer(3,itype,iphase))    &
          ...
          hsoa_a03(i,k,j)=  chem(i,k,j,lptr_opcg2_f_o_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg3_f_o_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg4_f_o_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg5_f_o_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg6_f_o_aer(3,itype,iphase))

          bbsoa_a03(i,k,j)= chem(i,k,j,lptr_opcg1_b_o_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg2_b_o_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg3_b_o_aer(3,itype,iphase)) &
                       +chem(i,k,j,lptr_opcg4_b_o_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg5_b_o_aer(3,itype,iphase)) &
   ...
   do itype=1,ntype_aer
         ...
         soa_a04(i,k,j)= chem(i,k,j,lptr_opcg2_f_o_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg3_f_o_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg4_f_o_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg5_f_o_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg6_f_o_aer(4,itype,iphase)) &
        ...
        arosoa_a04(i,k,j)= chem(i,k,j,lptr_biog1_c_aer(4,itype,iphase))    &
                       + chem(i,k,j,lptr_biog2_c_aer(4,itype,iphase))      &
                       + chem(i,k,j,lptr_biog3_c_aer(4,itype,iphase))      &
                       + chem(i,k,j,lptr_biog4_c_aer(4,itype,iphase))      &
                       + chem(i,k,j,lptr_ant2_o_aer(4,itype,iphase))      &
        ...
        biog_a04(i,k,j)= chem(i,k,j,lptr_ant1_c_aer(4,itype,iphase))    &
                       + chem(i,k,j,lptr_ant2_c_aer(4,itype,iphase))    &
                       + chem(i,k,j,lptr_ant3_c_aer(4,itype,iphase))    &
                       + chem(i,k,j,lptr_ant4_c_aer(4,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_o_aer(4,itype,iphase))    &
          ...
          hsoa_a04(i,k,j)=  chem(i,k,j,lptr_opcg2_f_o_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg3_f_o_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg4_f_o_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg5_f_o_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg6_f_o_aer(4,itype,iphase))

          bbsoa_a04(i,k,j)=chem(i,k,j,lptr_opcg1_b_o_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg2_b_o_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg3_b_o_aer(4,itype,iphase)) & 
                       + chem(i,k,j,lptr_opcg4_b_o_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg5_b_o_aer(4,itype,iphase)) &
   ...
   enddo 
      ...
      end subroutine sum_iepox_vbs

      subroutine sum_iepox_vbs_aq (                                    &
             alt, chem,                                                &
   ...
   do itype=1,ntype_aer
         ...
         soa_cw01(i,k,j)= chem(i,k,j,lptr_opcg2_f_o_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg3_f_o_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg4_f_o_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg5_f_o_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg6_f_o_aer(1,itype,iphase)) &
        ...
        arosoa_cw01(i,k,j)= chem(i,k,j,lptr_biog1_c_aer(1,itype,iphase))    &
                       + chem(i,k,j,lptr_biog2_c_aer(1,itype,iphase))      &
                       + chem(i,k,j,lptr_biog3_c_aer(1,itype,iphase))      &
                       + chem(i,k,j,lptr_biog4_c_aer(1,itype,iphase))      &
                       + chem(i,k,j,lptr_ant2_o_aer(1,itype,iphase))      &
        ...
        biog_cw01(i,k,j)= chem(i,k,j,lptr_ant1_c_aer(1,itype,iphase))    &
                       + chem(i,k,j,lptr_ant2_c_aer(1,itype,iphase))    &
                       + chem(i,k,j,lptr_ant3_c_aer(1,itype,iphase))    &
                       + chem(i,k,j,lptr_ant4_c_aer(1,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_o_aer(1,itype,iphase))    &
          ...
          hsoa_cw01(i,k,j)=  chem(i,k,j,lptr_opcg2_f_o_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg3_f_o_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg4_f_o_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg5_f_o_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg6_f_o_aer(1,itype,iphase))

          bbsoa_cw01(i,k,j)= chem(i,k,j,lptr_opcg1_b_o_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg2_b_o_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg3_b_o_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg4_b_o_aer(1,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg5_b_o_aer(1,itype,iphase)) &
   ...
   do itype=1,ntype_aer
         ...
         soa_cw02(i,k,j)= chem(i,k,j,lptr_opcg2_f_o_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg3_f_o_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg4_f_o_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg5_f_o_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg6_f_o_aer(2,itype,iphase)) &
        ...
        arosoa_cw02(i,k,j)= chem(i,k,j,lptr_biog1_c_aer(2,itype,iphase))    &
                       + chem(i,k,j,lptr_biog2_c_aer(2,itype,iphase))      &
                       + chem(i,k,j,lptr_biog3_c_aer(2,itype,iphase))      &
                       + chem(i,k,j,lptr_biog4_c_aer(2,itype,iphase))      &
                       + chem(i,k,j,lptr_ant2_o_aer(2,itype,iphase))      &
        ...
        biog_cw02(i,k,j)= chem(i,k,j,lptr_ant1_c_aer(2,itype,iphase))    &
                       + chem(i,k,j,lptr_ant2_c_aer(2,itype,iphase))    &
                       + chem(i,k,j,lptr_ant3_c_aer(2,itype,iphase))    &
                       + chem(i,k,j,lptr_ant4_c_aer(2,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_o_aer(2,itype,iphase))    &
          ...
          hsoa_cw02(i,k,j)=  chem(i,k,j,lptr_opcg2_f_o_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg3_f_o_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg4_f_o_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg5_f_o_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg6_f_o_aer(2,itype,iphase))

          bbsoa_cw02(i,k,j)= chem(i,k,j,lptr_opcg1_b_o_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg2_b_o_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg3_b_o_aer(2,itype,iphase))&
                       + chem(i,k,j,lptr_opcg4_b_o_aer(2,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg5_b_o_aer(2,itype,iphase))&
   ...
   do itype=1,ntype_aer
         ...
         soa_cw03(i,k,j)= chem(i,k,j,lptr_opcg2_f_o_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg3_f_o_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg4_f_o_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg5_f_o_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg6_f_o_aer(3,itype,iphase)) &
        ...
        arosoa_cw03(i,k,j)= chem(i,k,j,lptr_biog1_c_aer(3,itype,iphase))    &
                       + chem(i,k,j,lptr_biog2_c_aer(3,itype,iphase))      &
                       + chem(i,k,j,lptr_biog3_c_aer(3,itype,iphase))      &
                       + chem(i,k,j,lptr_biog4_c_aer(3,itype,iphase))      &
                       + chem(i,k,j,lptr_ant2_o_aer(3,itype,iphase))      &
        ...
        biog_cw03(i,k,j)= chem(i,k,j,lptr_ant1_c_aer(3,itype,iphase))    &
                       + chem(i,k,j,lptr_ant2_c_aer(3,itype,iphase))    &
                       + chem(i,k,j,lptr_ant3_c_aer(3,itype,iphase))    &
                       + chem(i,k,j,lptr_ant4_c_aer(3,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_o_aer(3,itype,iphase))    &
          ...
          hsoa_cw03(i,k,j)=  chem(i,k,j,lptr_opcg2_f_o_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg3_f_o_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg4_f_o_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg5_f_o_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg6_f_o_aer(3,itype,iphase))

          bbsoa_cw03(i,k,j)=chem(i,k,j,lptr_opcg1_b_o_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg2_b_o_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg3_b_o_aer(3,itype,iphase))& 
                       + chem(i,k,j,lptr_opcg4_b_o_aer(3,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg5_b_o_aer(3,itype,iphase)) &
   ...
   do itype=1,ntype_aer
         ...
         soa_cw04(i,k,j)= chem(i,k,j,lptr_opcg2_f_o_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg3_f_o_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg4_f_o_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg5_f_o_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg6_f_o_aer(4,itype,iphase)) &
        ...
        arosoa_cw04(i,k,j)= chem(i,k,j,lptr_biog1_c_aer(4,itype,iphase))    &
                       + chem(i,k,j,lptr_biog2_c_aer(4,itype,iphase))      &
                       + chem(i,k,j,lptr_biog3_c_aer(4,itype,iphase))      &
                       + chem(i,k,j,lptr_biog4_c_aer(4,itype,iphase))      &
                       + chem(i,k,j,lptr_ant2_o_aer(4,itype,iphase))      &
        ...
        biog_cw04(i,k,j)= chem(i,k,j,lptr_ant1_c_aer(4,itype,iphase))    &
                       + chem(i,k,j,lptr_ant2_c_aer(4,itype,iphase))    &
                       + chem(i,k,j,lptr_ant3_c_aer(4,itype,iphase))    &
                       + chem(i,k,j,lptr_ant4_c_aer(4,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_o_aer(4,itype,iphase))    &
          ...
          hsoa_cw04(i,k,j)=  chem(i,k,j,lptr_opcg2_f_o_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg3_f_o_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg4_f_o_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg5_f_o_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg6_f_o_aer(4,itype,iphase))

          bbsoa_cw04(i,k,j)= chem(i,k,j,lptr_opcg1_b_o_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg2_b_o_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg3_b_o_aer(4,itype,iphase))& 
                       + chem(i,k,j,lptr_opcg4_b_o_aer(4,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg5_b_o_aer(4,itype,iphase)) &
   ...
   enddo 
      ...
      end subroutine sum_iepox_vbs_aq
       ...
       subroutine  sum_vbs2 ( aero_diag_opt,                           &
             ...
             totoa_a09,totoa_a10,totoa_a11,totoa_a12,                  &
             totoa_a13,totoa_a14,totoa_a15,totoa_a16,                  &
             totoa_a17,totoa_a18,totoa_a19,totoa_a20,                  &
   ...
   kmax = kte
    ...
    totoa_a09(its:imax,kts:kmax,jts:jmax)    = 0.
    totoa_a10(its:imax,kts:kmax,jts:jmax)    = 0.
    totoa_a11(its:imax,kts:kmax,jts:jmax)    = 0.
    totoa_a12(its:imax,kts:kmax,jts:jmax)    = 0.
    totoa_a13(its:imax,kts:kmax,jts:jmax)    = 0.
    totoa_a14(its:imax,kts:kmax,jts:jmax)    = 0.
    totoa_a15(its:imax,kts:kmax,jts:jmax)    = 0.
    totoa_a16(its:imax,kts:kmax,jts:jmax)    = 0.
    totoa_a17(its:imax,kts:kmax,jts:jmax)    = 0.
    totoa_a18(its:imax,kts:kmax,jts:jmax)    = 0.
    totoa_a19(its:imax,kts:kmax,jts:jmax)    = 0.
    totoa_a20(its:imax,kts:kmax,jts:jmax)    = 0.
            ...
            do k=kts,kmax
               do i=its,imax
                 ...
                 totoa_a05(i,k,j) = (chem(i,k,j,lptr_pcg1_b_c_aer(5,itype,iphase)) &
                       ...
                       + chem(i,k,j,lptr_biog2_c_aer(5,itype,iphase))    &
                 ...
                 totoa_a06(i,k,j) = (chem(i,k,j,lptr_pcg1_b_c_aer(6,itype,iphase)) &
                       ...
                       + chem(i,k,j,lptr_biog2_c_aer(6,itype,iphase))    &
                 ...
                 totoa_a07(i,k,j) = (chem(i,k,j,lptr_pcg1_b_c_aer(7,itype,iphase)) &
                       ...
                       + chem(i,k,j,lptr_biog2_c_aer(7,itype,iphase))    &
                 ...
                 totoa_a08(i,k,j) = (chem(i,k,j,lptr_pcg1_b_c_aer(8,itype,iphase)) &
                       ...
                       + chem(i,k,j,lptr_biog2_c_aer(8,itype,iphase))    &
                       + chem(i,k,j,lptr_oc_aer(8,itype,iphase)))

                 totoa_a09(i,k,j) = (chem(i,k,j,lptr_pcg1_b_c_aer(9,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_b_c_aer(9,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_b_o_aer(9,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_b_o_aer(9,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_b_c_aer(9,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_b_o_aer(9,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_f_c_aer(9,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_f_c_aer(9,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_f_o_aer(9,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_f_o_aer(9,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_f_c_aer(9,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_f_o_aer(9,itype,iphase)) &
                       + chem(i,k,j,lptr_ant1_c_aer(9,itype,iphase))    &
                       + chem(i,k,j,lptr_ant1_o_aer(9,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_c_aer(9,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_o_aer(9,itype,iphase))    &
                       + chem(i,k,j,lptr_biog2_c_aer(9,itype,iphase))    &
                       + chem(i,k,j,lptr_oc_aer(9,itype,iphase)))

                 totoa_a10(i,k,j) = (chem(i,k,j,lptr_pcg1_b_c_aer(10,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_b_c_aer(10,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_b_o_aer(10,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_b_o_aer(10,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_b_c_aer(10,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_b_o_aer(10,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_f_c_aer(10,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_f_c_aer(10,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_f_o_aer(10,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_f_o_aer(10,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_f_c_aer(10,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_f_o_aer(10,itype,iphase)) &
                       + chem(i,k,j,lptr_ant1_c_aer(10,itype,iphase))    &
                       + chem(i,k,j,lptr_ant1_o_aer(10,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_c_aer(10,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_o_aer(10,itype,iphase))    &
                       + chem(i,k,j,lptr_biog2_c_aer(10,itype,iphase))    &
                       + chem(i,k,j,lptr_oc_aer(10,itype,iphase)))

                 totoa_a11(i,k,j) = (chem(i,k,j,lptr_pcg1_b_c_aer(11,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_b_c_aer(11,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_b_o_aer(11,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_b_o_aer(11,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_b_c_aer(11,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_b_o_aer(11,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_f_c_aer(11,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_f_c_aer(11,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_f_o_aer(11,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_f_o_aer(11,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_f_c_aer(11,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_f_o_aer(11,itype,iphase)) &
                       + chem(i,k,j,lptr_ant1_c_aer(11,itype,iphase))    &
                       + chem(i,k,j,lptr_ant1_o_aer(11,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_c_aer(11,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_o_aer(11,itype,iphase))    &
                       + chem(i,k,j,lptr_biog2_c_aer(11,itype,iphase))    &
                       + chem(i,k,j,lptr_oc_aer(11,itype,iphase)))

                 totoa_a12(i,k,j) = (chem(i,k,j,lptr_pcg1_b_c_aer(12,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_b_c_aer(12,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_b_o_aer(12,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_b_o_aer(12,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_b_c_aer(12,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_b_o_aer(12,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_f_c_aer(12,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_f_c_aer(12,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_f_o_aer(12,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_f_o_aer(12,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_f_c_aer(12,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_f_o_aer(12,itype,iphase)) &
                       + chem(i,k,j,lptr_ant1_c_aer(12,itype,iphase))    &
                       + chem(i,k,j,lptr_ant1_o_aer(12,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_c_aer(12,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_o_aer(12,itype,iphase))    &
                       + chem(i,k,j,lptr_biog2_c_aer(12,itype,iphase))    &
                       + chem(i,k,j,lptr_oc_aer(12,itype,iphase)))

                 totoa_a13(i,k,j) = (chem(i,k,j,lptr_pcg1_b_c_aer(13,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_b_c_aer(13,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_b_o_aer(13,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_b_o_aer(13,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_b_c_aer(13,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_b_o_aer(13,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_f_c_aer(13,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_f_c_aer(13,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_f_o_aer(13,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_f_o_aer(13,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_f_c_aer(13,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_f_o_aer(13,itype,iphase)) &
                       + chem(i,k,j,lptr_ant1_c_aer(13,itype,iphase))    &
                       + chem(i,k,j,lptr_ant1_o_aer(13,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_c_aer(13,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_o_aer(13,itype,iphase))    &
                       + chem(i,k,j,lptr_biog2_c_aer(13,itype,iphase))    &
                       + chem(i,k,j,lptr_oc_aer(13,itype,iphase)))

                 totoa_a14(i,k,j) = (chem(i,k,j,lptr_pcg1_b_c_aer(14,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_b_c_aer(14,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_b_o_aer(14,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_b_o_aer(14,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_b_c_aer(14,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_b_o_aer(14,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_f_c_aer(14,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_f_c_aer(14,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_f_o_aer(14,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_f_o_aer(14,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_f_c_aer(14,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_f_o_aer(14,itype,iphase)) &
                       + chem(i,k,j,lptr_ant1_c_aer(14,itype,iphase))    &
                       + chem(i,k,j,lptr_ant1_o_aer(14,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_c_aer(14,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_o_aer(14,itype,iphase))    &
                       + chem(i,k,j,lptr_biog2_c_aer(14,itype,iphase))    &
                       + chem(i,k,j,lptr_oc_aer(14,itype,iphase)))

                 totoa_a15(i,k,j) = (chem(i,k,j,lptr_pcg1_b_c_aer(15,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_b_c_aer(15,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_b_o_aer(15,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_b_o_aer(15,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_b_c_aer(15,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_b_o_aer(15,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_f_c_aer(15,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_f_c_aer(15,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_f_o_aer(15,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_f_o_aer(15,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_f_c_aer(15,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_f_o_aer(15,itype,iphase)) &
                       + chem(i,k,j,lptr_ant1_c_aer(15,itype,iphase))    &
                       + chem(i,k,j,lptr_ant1_o_aer(15,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_c_aer(15,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_o_aer(15,itype,iphase))    &
                       + chem(i,k,j,lptr_biog2_c_aer(15,itype,iphase))    &
                       + chem(i,k,j,lptr_oc_aer(15,itype,iphase)))

                 totoa_a16(i,k,j) = (chem(i,k,j,lptr_pcg1_b_c_aer(16,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_b_c_aer(16,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_b_o_aer(16,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_b_o_aer(16,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_b_c_aer(16,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_b_o_aer(16,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_f_c_aer(16,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_f_c_aer(16,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_f_o_aer(16,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_f_o_aer(16,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_f_c_aer(16,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_f_o_aer(16,itype,iphase)) &
                       + chem(i,k,j,lptr_ant1_c_aer(16,itype,iphase))    &
                       + chem(i,k,j,lptr_ant1_o_aer(16,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_c_aer(16,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_o_aer(16,itype,iphase))    &
                       + chem(i,k,j,lptr_biog2_c_aer(16,itype,iphase))    &
                       + chem(i,k,j,lptr_oc_aer(16,itype,iphase)))

                 totoa_a17(i,k,j) = (chem(i,k,j,lptr_pcg1_b_c_aer(17,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_b_c_aer(17,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_b_o_aer(17,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_b_o_aer(17,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_b_c_aer(17,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_b_o_aer(17,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_f_c_aer(17,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_f_c_aer(17,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_f_o_aer(17,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_f_o_aer(17,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_f_c_aer(17,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_f_o_aer(17,itype,iphase)) &
                       + chem(i,k,j,lptr_ant1_c_aer(17,itype,iphase))    &
                       + chem(i,k,j,lptr_ant1_o_aer(17,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_c_aer(17,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_o_aer(17,itype,iphase))    &
                       + chem(i,k,j,lptr_biog2_c_aer(17,itype,iphase))    &
                       + chem(i,k,j,lptr_oc_aer(17,itype,iphase)))

                 totoa_a18(i,k,j) = (chem(i,k,j,lptr_pcg1_b_c_aer(18,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_b_c_aer(18,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_b_o_aer(18,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_b_o_aer(18,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_b_c_aer(18,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_b_o_aer(18,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_f_c_aer(18,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_f_c_aer(18,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_f_o_aer(18,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_f_o_aer(18,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_f_c_aer(18,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_f_o_aer(18,itype,iphase)) &
                       + chem(i,k,j,lptr_ant1_c_aer(18,itype,iphase))    &
                       + chem(i,k,j,lptr_ant1_o_aer(18,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_c_aer(18,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_o_aer(18,itype,iphase))    &
                       + chem(i,k,j,lptr_biog2_c_aer(18,itype,iphase))    &
                       + chem(i,k,j,lptr_oc_aer(18,itype,iphase)))

                 totoa_a19(i,k,j) = (chem(i,k,j,lptr_pcg1_b_c_aer(19,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_b_c_aer(19,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_b_o_aer(19,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_b_o_aer(19,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_b_c_aer(19,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_b_o_aer(19,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_f_c_aer(19,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_f_c_aer(19,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_f_o_aer(19,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_f_o_aer(19,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_f_c_aer(19,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_f_o_aer(19,itype,iphase)) &
                       + chem(i,k,j,lptr_ant1_c_aer(19,itype,iphase))    &
                       + chem(i,k,j,lptr_ant1_o_aer(19,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_c_aer(19,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_o_aer(19,itype,iphase))    &
                       + chem(i,k,j,lptr_biog2_c_aer(19,itype,iphase))    &
                       + chem(i,k,j,lptr_oc_aer(19,itype,iphase)))

                 totoa_a20(i,k,j) = (chem(i,k,j,lptr_pcg1_b_c_aer(20,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_b_c_aer(20,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_b_o_aer(20,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_b_o_aer(20,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_b_c_aer(20,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_b_o_aer(20,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_f_c_aer(20,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_f_c_aer(20,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg1_f_o_aer(20,itype,iphase)) &
                       + chem(i,k,j,lptr_pcg2_f_o_aer(20,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_f_c_aer(20,itype,iphase)) &
                       + chem(i,k,j,lptr_opcg1_f_o_aer(20,itype,iphase)) &
                       + chem(i,k,j,lptr_ant1_c_aer(20,itype,iphase))    &
                       + chem(i,k,j,lptr_ant1_o_aer(20,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_c_aer(20,itype,iphase))    &
                       + chem(i,k,j,lptr_biog1_o_aer(20,itype,iphase))    &
                       + chem(i,k,j,lptr_biog2_c_aer(20,itype,iphase))    &
                       + chem(i,k,j,lptr_oc_aer(20,itype,iphase)))
               enddo
            enddo
         enddo
   enddo 
