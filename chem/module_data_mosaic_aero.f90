module module_data_mosaic_aero
  ...
  integer, parameter :: nbin_a_max = 20  
  ...
  integer, parameter :: ngas_soa = 68+2+16+10+1	

  integer, parameter :: ngas_het = 2
  integer, parameter :: ngas_volatile = ngas_ioa + ngas_soa + 3 
  integer, parameter :: ngas_aerchtot = ngas_volatile + ngas_het 

  integer, parameter :: naer = 5+68+2+16+10+2+2+5+5+6	

  integer, parameter :: naercomp = 25+68+2+16+10+2+2+5+5+1	
