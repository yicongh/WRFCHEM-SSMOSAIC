...
MODULE saprc99_mosaic_12bin_vbs2_aq_Integrator

 USE saprc99_mosaic_12bin_vbs2_aq_Parameters
 USE saprc99_mosaic_12bin_vbs2_aq_Precision
...
SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_INTEGRATE( TIN, TOUT, &
  ...
  ICNTRL_U, RCNTRL_U, ISTATUS_U, RSTATUS_U, IERR_U  )
   ...
   CALL saprc99_mosaic_12bin_vbs2_aq_Rosenbrock(VAR, FIX, RCONST, TIN,TOUT,   &
         ATOL,RTOL,               &
...
END SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_INTEGRATE


SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_Rosenbrock(Y, FIX, RCONST, Tstart,Tend, &
           AbsTol,RelTol,            &
           RCNTRL,ICNTRL,RSTATUS,ISTATUS,IRR_WRK,IERR)
  ...
  INTEGER :: Nfun,Njac,Nstp,Nacc,Nrej,Ndec,Nsol,Nsng
   ...
   ELSE
      ...
      CALL saprc99_mosaic_12bin_vbs2_aq_ros_ErrorMsg(-2,Tstart,ZERO,IERR)
      RETURN
   END IF
   ...
   ELSE
      ...
      CALL saprc99_mosaic_12bin_vbs2_aq_ros_ErrorMsg(-1,Tstart,ZERO,IERR)
      RETURN
   END IF


   Roundoff = saprc99_mosaic_12bin_vbs2_aq_WLAMCH('E')
   ...
   ELSE
      ...
      CALL saprc99_mosaic_12bin_vbs2_aq_ros_ErrorMsg(-3,Tstart,ZERO,IERR)
      RETURN
   END IF
   ...
   ELSE
      ...
      CALL saprc99_mosaic_12bin_vbs2_aq_ros_ErrorMsg(-4,Tstart,ZERO,IERR)
      RETURN
   END IF
   ...
   END IF
    ...
    DO i=1,UplimTol
      IF ( (AbsTol(i) <= ZERO) .OR. (RelTol(i) <= 10.0_dp*Roundoff) &
        ...
        CALL saprc99_mosaic_12bin_vbs2_aq_ros_ErrorMsg(-5,Tstart,ZERO,IERR)
        RETURN
      END IF
    END DO
   ...
   SELECT CASE (Method)
     CASE (1)
       CALL saprc99_mosaic_12bin_vbs2_aq_Ros2(ros_S, ros_A, ros_C, ros_M, ros_E,   &
          ros_Alpha, ros_Gamma, ros_NewF, ros_ELO, ros_Name)
     CASE (2)
       CALL saprc99_mosaic_12bin_vbs2_aq_Ros3(ros_S, ros_A, ros_C, ros_M, ros_E,   &
          ros_Alpha, ros_Gamma, ros_NewF, ros_ELO, ros_Name)
     CASE (3)
       CALL saprc99_mosaic_12bin_vbs2_aq_Ros4(ros_S, ros_A, ros_C, ros_M, ros_E,   &
          ros_Alpha, ros_Gamma, ros_NewF, ros_ELO, ros_Name)
     CASE (4)
       CALL saprc99_mosaic_12bin_vbs2_aq_Rodas3(ros_S, ros_A, ros_C, ros_M, ros_E, &
          ros_Alpha, ros_Gamma, ros_NewF, ros_ELO, ros_Name)
     CASE (5)
       CALL saprc99_mosaic_12bin_vbs2_aq_Rodas4(ros_S, ros_A, ros_C, ros_M, ros_E, &
          ros_Alpha, ros_Gamma, ros_NewF, ros_ELO, ros_Name)
     CASE DEFAULT
   ...
   CALL saprc99_mosaic_12bin_vbs2_aq_ros_Integrator(Y,Tstart,Tend,Texit,      &
        AbsTol, RelTol,                          &
...
CONTAINS 
 ...
 SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_ros_ErrorMsg(Code,T,H,IERR)
 ...
 END SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_ros_ErrorMsg


 SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_ros_Integrator (Y, Tstart, Tend, T,     &
        AbsTol, RelTol,                          &
...
TimeLoop: DO WHILE ( (Direction > 0).AND.((T-Tend)+Roundoff <= ZERO) &
   ...
   IF ( Nstp > Max_no_steps ) THEN  
      CALL saprc99_mosaic_12bin_vbs2_aq_ros_ErrorMsg(-6,T,H,IERR)
      RETURN
   END IF
   IF ( ((T+0.1_dp*H) == T).OR.(H <= Roundoff) ) THEN  
      CALL saprc99_mosaic_12bin_vbs2_aq_ros_ErrorMsg(-7,T,H,IERR)
      RETURN
   END IF
   ...
   CALL saprc99_mosaic_12bin_vbs2_aq_FunTemplate(T,Y,Fcn0, RCONST, FIX, Nfun)
   IF( T == Tstart ) THEN
     CALL saprc99_mosaic_12bin_vbs2_aq_IRRFun( Y, FIX, RCONST, IRR_WRK )
   ENDIF


   IF (.NOT.Autonomous) THEN
      CALL saprc99_mosaic_12bin_vbs2_aq_ros_FunTimeDeriv ( T, Roundoff, Y, &
                Fcn0, dFdT, RCONST, FIX, Nfun )
   END IF


   CALL saprc99_mosaic_12bin_vbs2_aq_JacTemplate(T,Y,Jac0, FIX, Njac, RCONST)


UntilAccepted: DO

   CALL saprc99_mosaic_12bin_vbs2_aq_ros_PrepareMatrix(H,Direction,ros_Gamma(1), &
          Jac0,Ghimj,Pivot,Singular, Ndec,  Nsng )
   IF (Singular) THEN 
       CALL saprc99_mosaic_12bin_vbs2_aq_ros_ErrorMsg(-8,T,H,IERR)
       RETURN
   END IF
...
Stage: DO istage = 1, ros_S
       ...
       IF ( istage == 1 ) THEN
         CALL saprc99_mosaic_12bin_vbs2_aq_WCOPY(NVAR,Fcn0,1,Fcn,1)
      
       ELSEIF ( ros_NewF(istage) ) THEN
         CALL saprc99_mosaic_12bin_vbs2_aq_WCOPY(NVAR,Y,1,Ynew,1)
         DO j = 1, istage-1
           CALL saprc99_mosaic_12bin_vbs2_aq_WAXPY(NVAR,ros_A((istage-1)*(istage-2)/2+j), &
            K(NVAR*(j-1)+1),1,Ynew,1)
         END DO
         Tau = T + ros_Alpha(istage)*Direction*H
         CALL saprc99_mosaic_12bin_vbs2_aq_FunTemplate(Tau,Ynew,Fcn, RCONST, FIX, Nfun)
       END IF 
       CALL saprc99_mosaic_12bin_vbs2_aq_WCOPY(NVAR,Fcn,1,K(ioffset+1),1)
       DO j = 1, istage-1
         HC = ros_C((istage-1)*(istage-2)/2+j)/(Direction*H)
         CALL saprc99_mosaic_12bin_vbs2_aq_WAXPY(NVAR,HC,K(NVAR*(j-1)+1),1,K(ioffset+1),1)
       END DO
       IF ((.NOT. Autonomous).AND.(ros_Gamma(istage).NE.ZERO)) THEN
         HG = Direction*H*ros_Gamma(istage)
         CALL saprc99_mosaic_12bin_vbs2_aq_WAXPY(NVAR,HG,dFdT,1,K(ioffset+1),1)
       END IF
       CALL saprc99_mosaic_12bin_vbs2_aq_ros_Solve(Ghimj, Pivot, K(ioffset+1), Nsol)
   ...
   CALL saprc99_mosaic_12bin_vbs2_aq_WCOPY(NVAR,Y,1,Ynew,1)
   DO j=1,ros_S
         CALL saprc99_mosaic_12bin_vbs2_aq_WAXPY(NVAR,ros_M(j),K(NVAR*(j-1)+1),1,Ynew,1)
   END DO


   CALL saprc99_mosaic_12bin_vbs2_aq_WSCAL(NVAR,ZERO,Yerr,1)
   DO j=1,ros_S
        CALL saprc99_mosaic_12bin_vbs2_aq_WAXPY(NVAR,ros_E(j),K(NVAR*(j-1)+1),1,Yerr,1)
   END DO
   Err = saprc99_mosaic_12bin_vbs2_aq_ros_ErrorNorm ( Y, Ynew, Yerr, AbsTol, RelTol, VectorTol )
   ...
   IF ( (Err <= ONE).OR.(H <= Hmin) ) THEN  
      Nacc = Nacc+1
      CALL saprc99_mosaic_12bin_vbs2_aq_WCOPY(NVAR,Ynew,1,Y,1)
      T = T + Direction*H
  ...
  END SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_ros_Integrator



  REAL(kind=dp) FUNCTION  saprc99_mosaic_12bin_vbs2_aq_ros_ErrorNorm ( Y, Ynew, Yerr, &
   ...
   Err  = SQRT(Err/NVAR)
    ...
    saprc99_mosaic_12bin_vbs2_aq_ros_ErrorNorm = Err

  END FUNCTION  saprc99_mosaic_12bin_vbs2_aq_ros_ErrorNorm



  SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_ros_FunTimeDeriv ( T, Roundoff, Y, &
                Fcn0, dFdT, RCONST, FIX, Nfun )
   ...
   CALL saprc99_mosaic_12bin_vbs2_aq_FunTemplate(T+Delta,Y,dFdT, RCONST, FIX, Nfun)
   CALL saprc99_mosaic_12bin_vbs2_aq_WAXPY(NVAR,(-ONE),Fcn0,1,dFdT,1)
   CALL saprc99_mosaic_12bin_vbs2_aq_WSCAL(NVAR,(ONE/Delta),dFdT,1)

  END SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_ros_FunTimeDeriv



  SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_ros_PrepareMatrix ( H, Direction, gam, &
             Jac0, Ghimj, Pivot, Singular, Ndec,  Nsng  )
   ...
   DO WHILE (Singular)
     ...
     CALL saprc99_mosaic_12bin_vbs2_aq_WCOPY(LU_NONZERO,Jac0,1,Ghimj,1)
     CALL saprc99_mosaic_12bin_vbs2_aq_WSCAL(LU_NONZERO,(-ONE),Ghimj,1)
     ghinv = ONE/(Direction*H*gam)
     DO i=1,NVAR
       Ghimj(LU_DIAG(i)) = Ghimj(LU_DIAG(i))+ghinv
     END DO

     CALL saprc99_mosaic_12bin_vbs2_aq_ros_Decomp( Ghimj, Pivot, ising, Ndec )
     IF (ising == 0) THEN
  ...
  END SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_ros_PrepareMatrix



  SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_ros_Decomp( A, Pivot, ising, Ndec )
   ...
   CALL saprc99_mosaic_12bin_vbs2_aq_KppDecomp ( A, ising )
   Pivot(1) = 1
   Ndec = Ndec + 1

  END SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_ros_Decomp



  SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_ros_Solve( A, Pivot, b, Nsol )
   ...
   CALL saprc99_mosaic_12bin_vbs2_aq_KppSolve( A, b )

   Nsol = Nsol+1

  END SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_ros_Solve




  SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_Ros2 (ros_S,ros_A,ros_C,ros_M,ros_E,ros_Alpha,&
 ...
 END SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_Ros2



  SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_Ros3 (ros_S,ros_A,ros_C,ros_M,ros_E,ros_Alpha,&
           ros_Gamma,ros_NewF,ros_ELO,ros_Name)
  ...
  END SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_Ros3





  SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_Ros4 (ros_S,ros_A,ros_C,ros_M,ros_E,ros_Alpha,&
           ros_Gamma,ros_NewF,ros_ELO,ros_Name)
  ...
  END SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_Ros4


  SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_Rodas3 (ros_S,ros_A,ros_C,ros_M,ros_E,ros_Alpha,&
            ros_Gamma,ros_NewF,ros_ELO,ros_Name)
  ...
  END SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_Rodas3


  SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_Rodas4 (ros_S,ros_A,ros_C,ros_M,ros_E,ros_Alpha,&
             ros_Gamma,ros_NewF,ros_ELO,ros_Name)
  ...
  END SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_Rodas4




END SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_Rosenbrock




SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_FunTemplate( T, Y, Ydot, RCONST, FIX, Nfun )
   ...
   CALL saprc99_mosaic_12bin_vbs2_aq_Fun( Y, FIX, RCONST, Ydot )


   Nfun = Nfun+1

END SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_FunTemplate



SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_JacTemplate( T, Y, Jcb, FIX, Njac, RCONST )
 ...
 USE saprc99_mosaic_12bin_vbs2_aq_Jacobian
    ...
    CALL saprc99_mosaic_12bin_vbs2_aq_Jac_SP( Y, FIX, RCONST, Jcb )


    Njac = Njac+1

END SUBROUTINE  saprc99_mosaic_12bin_vbs2_aq_JacTemplate
...
SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_Fun ( V, F, RCT, Vdot )
...
END SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_Fun
...
SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_IRRFun ( V, F, RCT, IRR )
...
END SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_IRRFun
...
SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_Jac_SP ( V, F, RCT, JVS )
...
END SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_Jac_SP
...
SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_KppDecomp( JVS, IER )
...
END SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_KppDecomp



SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_KppDecompCmplx( JVS, IER )
...
END SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_KppDecompCmplx


SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_KppSolveIndirect( JVS, X )
...
END SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_KppSolveIndirect


SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_KppSolveCmplx( JVS, X )
...
END SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_KppSolveCmplx
...
SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_KppSolve ( JVS, X )
...
END SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_KppSolve
      ...
      SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_WCOPY(N,X,incX,Y,incY)
      ...
      END SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_WCOPY



      SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_WAXPY(N,Alpha,X,incX,Y,incY)
      ...
      END SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_WAXPY




      SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_WSCAL(N,Alpha,X,incX)
      ...
      END SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_WSCAL


      REAL(kind=dp) FUNCTION saprc99_mosaic_12bin_vbs2_aq_WLAMCH( C )
      ...
      IF (First) THEN
        ...
        DO i = 17, 80
          Eps = Eps*HALF
          CALL saprc99_mosaic_12bin_vbs2_aq_WLAMCH_ADD(ONE,Eps,Sum)
...
10      Eps = Eps*2
      ...
      saprc99_mosaic_12bin_vbs2_aq_WLAMCH = Eps

      END FUNCTION saprc99_mosaic_12bin_vbs2_aq_WLAMCH
     
      SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_WLAMCH_ADD( A, B, Sum )

      
      REAL(kind=dp) A, B, Sum
      Sum = A + B

      END SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_WLAMCH_ADD




      SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_SET2ZERO(N,Y)
      ...
      END SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_SET2ZERO



      REAL(kind=dp) FUNCTION saprc99_mosaic_12bin_vbs2_aq_WDOT (N, DX, incX, DY, incY) 
      ...
      saprc99_mosaic_12bin_vbs2_aq_WDOT = 0.0D0 
      IF (N .LE. 0) RETURN 
    ...
    5 IX = 1 
      ...
      DO i = 1,N 
        saprc99_mosaic_12bin_vbs2_aq_WDOT = saprc99_mosaic_12bin_vbs2_aq_WDOT + DX(IX)*DY(IY) 
        IX = IX + incX 
        IY = IY + incY 
      END DO 
      RETURN 
   ...
   20 M = MOD(N,5) 
      IF (M .EQ. 0) GO TO 40 
      DO i = 1,M 
         saprc99_mosaic_12bin_vbs2_aq_WDOT = saprc99_mosaic_12bin_vbs2_aq_WDOT + DX(i)*DY(i) 
      END DO 
      IF (N .LT. 5) RETURN 
   40 MP1 = M + 1 
      DO i = MP1,N,5 
          saprc99_mosaic_12bin_vbs2_aq_WDOT = saprc99_mosaic_12bin_vbs2_aq_WDOT + DX(i)*DY(i) + DX(i+1)*DY(i+1) +&
                   DX(i+2)*DY(i+2) +  &
   ...
   60 NS = N*incX 
      ...
      END FUNCTION saprc99_mosaic_12bin_vbs2_aq_WDOT                                          




END MODULE saprc99_mosaic_12bin_vbs2_aq_Integrator
