...
is_nh3: if( p_nh3 >= param_first_scalar ) then
      ...
      SUBROUTINE depvel( numgas, rmol, zr, z0, ustar, &
        ...
        if(polint.lt.0.0) then
           print*,'rmol, zr, z0, polint:  ',rmol, zr, z0, polint
           if(rmol<0) then
              print*,'ar, ao, 1, 2:', ar, ao, &
                  alog((ar-1.0)/(ar+1.0)),alog((ao-1.0)/(ao+1.0))
           endif
        endif
...
"DEP_SEASONS NOT 5")
        ...
        hstar(1:numgas)  = 100.0 
        hstar4(1:numgas) = 100.0 
        dhr(1:numgas)    = 1000.0 
        f0(1:numgas)     = 0.0
        dvj(1:numgas)    = 0.1  
...
is_cbm4_kpp : &
       ...
       if (p_iepox.gt.1) then
        ...
        if (p_tetrol.gt.1) then
        hstar(p_tetrol)=1.0e8 
        f0(p_tetrol)=1.0
        dhr(p_tetrol)=6013.95 
        dvj(p_tetrol) = 1.9 * 0.136**(-2.0/3.0) / 100.0 
        endif

        if (p_cldtetrol.gt.1) then
        hstar(p_cldtetrol)=1.0e8 
        f0(p_cldtetrol)=1.0
        dhr(p_cldtetrol)=6013.95 
        dvj(p_cldtetrol) = 1.9 * 0.136**(-2.0/3.0) / 100.0 
        endif
        ...
        f0(p_gly)=1.0
        dhr(p_gly)=6013.95 
        dvj(p_gly) =  1.9 * 0.058**(-2.0/3.0) / 100.0 
        endif
     ...
     if(p_pcg1_b_c.gt.1)  hstar(p_pcg1_b_c) =2.82e7
     if(p_pcg2_b_c.gt.1)  hstar(p_pcg2_b_c) =7379.0
     if(p_pcg3_b_c.gt.1)  hstar(p_pcg3_b_c)=7379.0
     if(p_pcg4_b_c.gt.1)  hstar(p_pcg4_b_c)=7379.0
     if(p_pcg5_b_c.gt.1)  hstar(p_pcg5_b_c)=7379.0
     if(p_pcg6_b_c.gt.1)  hstar(p_pcg6_b_c)=7379.0
     if(p_pcg7_b_c.gt.1)  hstar(p_pcg7_b_c)=2.45e4
     if(p_pcg8_b_c.gt.1)  hstar(p_pcg8_b_c)=7379.0
     if(p_pcg9_b_c.gt.1)  hstar(p_pcg9_b_c)=7379.0
     if(p_opcg1_b_c.gt.1)  hstar(p_opcg1_b_c) =2.82e7
     if(p_opcg2_b_c.gt.1)  hstar(p_opcg2_b_c) =8.71e6
     if(p_opcg3_b_c.gt.1)  hstar(p_opcg3_b_c)=2.69e6
     if(p_opcg4_b_c.gt.1)  hstar(p_opcg4_b_c)=8.32e5
     if(p_opcg5_b_c.gt.1)  hstar(p_opcg5_b_c)=2.57e5
     if(p_opcg6_b_c.gt.1)  hstar(p_opcg6_b_c)=7.94e4
     if(p_opcg7_b_c.gt.1)  hstar(p_opcg7_b_c)=2.45e4
     if(p_opcg8_b_c.gt.1)  hstar(p_opcg8_b_c)=7379.0
     if(p_pcg1_b_o.gt.1)  hstar(p_pcg1_b_o) =7379.0
     if(p_pcg2_b_o.gt.1)  hstar(p_pcg2_b_o) =7379.0
     if(p_pcg3_b_o.gt.1)  hstar(p_pcg3_b_o)=7379.0
     if(p_pcg4_b_o.gt.1)  hstar(p_pcg4_b_o)=7379.0
     if(p_pcg5_b_o.gt.1)  hstar(p_pcg5_b_o)=7379.0
     if(p_pcg6_b_o.gt.1)  hstar(p_pcg6_b_o)=7379.0
     if(p_pcg7_b_o.gt.1)  hstar(p_pcg7_b_o)=7379.0
     if(p_pcg8_b_o.gt.1)  hstar(p_pcg8_b_o)=7379.0
     if(p_pcg9_b_o.gt.1)  hstar(p_pcg9_b_o)=7379.0
     if(p_opcg1_b_o.gt.1)  hstar(p_opcg1_b_o) =2.82e7
     if(p_opcg2_b_o.gt.1)  hstar(p_opcg2_b_o) =8.71e6
     if(p_opcg3_b_o.gt.1)  hstar(p_opcg3_b_o)=2.69e6
     if(p_opcg4_b_o.gt.1)  hstar(p_opcg4_b_o)=8.32e5
     if(p_opcg5_b_o.gt.1)  hstar(p_opcg5_b_o)=2.82e7
     if(p_opcg6_b_o.gt.1)  hstar(p_opcg6_b_o)=8.71e6
     if(p_opcg7_b_o.gt.1)  hstar(p_opcg7_b_o)=2.69e6
     if(p_opcg8_b_o.gt.1)  hstar(p_opcg8_b_o)=8.32e5
     if(p_pcg1_f_c.gt.1)  hstar(p_pcg1_f_c) =2.82e7
     if(p_pcg2_f_c.gt.1)  hstar(p_pcg2_f_c) =7379.0
     if(p_pcg3_f_c.gt.1)  hstar(p_pcg3_f_c)=7379.0
     if(p_pcg4_f_c.gt.1)  hstar(p_pcg4_f_c)=7379.0
     if(p_pcg5_f_c.gt.1)  hstar(p_pcg5_f_c)=7379.0
     if(p_pcg6_f_c.gt.1)  hstar(p_pcg6_f_c)=7379.0
     if(p_pcg7_f_c.gt.1)  hstar(p_pcg7_f_c)=2.45e4
     if(p_pcg8_f_c.gt.1)  hstar(p_pcg8_f_c)=7379.0
     if(p_pcg9_f_c.gt.1)  hstar(p_pcg9_f_c)=7379.0
     if(p_opcg1_f_c.gt.1)  hstar(p_opcg1_f_c) =7379.0
     if(p_opcg2_f_c.gt.1)  hstar(p_opcg2_f_c) =7379.0
     if(p_opcg3_f_c.gt.1)  hstar(p_opcg3_f_c)=7379.0
     if(p_opcg4_f_c.gt.1)  hstar(p_opcg4_f_c)=7379.0
     if(p_opcg5_f_c.gt.1)  hstar(p_opcg5_f_c)=7379.0
     if(p_opcg6_f_c.gt.1)  hstar(p_opcg6_f_c)=7379.0
     if(p_opcg7_f_c.gt.1)  hstar(p_opcg7_f_c)=7379.0
     if(p_opcg8_f_c.gt.1)  hstar(p_opcg8_f_c)=7379.0
     if(p_pcg1_f_o.gt.1)  hstar(p_pcg1_f_o) =7379.0
     if(p_pcg2_f_o.gt.1)  hstar(p_pcg2_f_o) =7379.0
     if(p_pcg3_f_o.gt.1)  hstar(p_pcg3_f_o)=7379.0
     if(p_pcg4_f_o.gt.1)  hstar(p_pcg4_f_o)=7379.0
     if(p_pcg5_f_o.gt.1)  hstar(p_pcg5_f_o)=7379.0
     if(p_pcg6_f_o.gt.1)  hstar(p_pcg6_f_o)=7379.0
     if(p_pcg7_f_o.gt.1)  hstar(p_pcg7_f_o)=7379.0
     if(p_pcg8_f_o.gt.1)  hstar(p_pcg8_f_o)=7379.0
     if(p_pcg9_f_o.gt.1)  hstar(p_pcg9_f_o)=7379.0
     if(p_opcg1_f_o.gt.1)  hstar(p_opcg1_f_o) =2.82e7
     if(p_opcg2_f_o.gt.1)  hstar(p_opcg2_f_o) =8.71e6
     if(p_opcg3_f_o.gt.1)  hstar(p_opcg3_f_o)=2.69e6
     if(p_opcg4_f_o.gt.1)  hstar(p_opcg4_f_o)=8.32e5
     if(p_opcg5_f_o.gt.1)  hstar(p_opcg5_f_o)=2.57e5
     if(p_opcg6_f_o.gt.1)  hstar(p_opcg6_f_o)=7.94e4
     if(p_opcg7_f_o.gt.1)  hstar(p_opcg7_f_o)=2.45e4
     if(p_opcg8_f_o.gt.1)  hstar(p_opcg8_f_o)=7379.0
     if(p_ant1_c.gt.1)     hstar(p_ant1_c)=8.91e10
     if(p_ant2_c.gt.1)     hstar(p_ant2_c)=1.12e10
     if(p_ant3_c.gt.1)     hstar(p_ant3_c)=1.41e9
     if(p_ant4_c.gt.1)     hstar(p_ant4_c)=1.78e8
     if(p_ant1_o.gt.1)     hstar(p_ant1_o)=8.91e10
     if(p_ant2_o.gt.1)     hstar(p_ant2_o)=1.12e10
     if(p_ant3_o.gt.1)     hstar(p_ant3_o)=1.41e9
     if(p_ant4_o.gt.1)     hstar(p_ant4_o)=1.78e8
     if(p_biog1_c.gt.1)    hstar(p_biog1_c)=1.74e10
     if(p_biog2_c.gt.1)    hstar(p_biog2_c)=2.45e9
     if(p_biog3_c.gt.1)    hstar(p_biog3_c)=3.47e8
     if(p_biog4_c.gt.1)    hstar(p_biog4_c)=4.90e7
     if(p_biog1_o.gt.1)    hstar(p_biog1_o)=8.91e10
     if(p_biog2_o.gt.1)    hstar(p_biog2_o)=1.12e10
     if(p_biog3_o.gt.1)    hstar(p_biog3_o)=1.41e9
     if(p_biog4_o.gt.1)    hstar(p_biog4_o)=1.78e8

     if(p_pcg1_b_c.gt.1)  dhr(p_pcg1_b_c) =6013.95
     if(p_pcg2_b_c.gt.1)  dhr(p_pcg2_b_c) =6013.95
     if(p_pcg3_b_c.gt.1)  dhr(p_pcg3_b_c)=6013.95
     if(p_pcg4_b_c.gt.1)  dhr(p_pcg4_b_c)=6013.95
     if(p_pcg5_b_c.gt.1)  dhr(p_pcg5_b_c)=6013.95
     if(p_pcg6_b_c.gt.1)  dhr(p_pcg6_b_c)=6013.95
     if(p_pcg7_b_c.gt.1)  dhr(p_pcg7_b_c)=6013.95
     if(p_pcg8_b_c.gt.1)  dhr(p_pcg8_b_c)=6013.95
     if(p_pcg9_b_c.gt.1)  dhr(p_pcg9_b_c)=6013.95
     if(p_opcg1_b_c.gt.1)  dhr(p_opcg1_b_c) =6013.95
     if(p_opcg2_b_c.gt.1)  dhr(p_opcg2_b_c) =6013.95
     if(p_opcg3_b_c.gt.1)  dhr(p_opcg3_b_c)=6013.95
     if(p_opcg4_b_c.gt.1)  dhr(p_opcg4_b_c)=6013.95
     if(p_opcg5_b_c.gt.1)  dhr(p_opcg5_b_c)=6013.95
     if(p_opcg6_b_c.gt.1)  dhr(p_opcg6_b_c)=6013.95
     if(p_opcg7_b_c.gt.1)  dhr(p_opcg7_b_c)=6013.95
     if(p_opcg8_b_c.gt.1)  dhr(p_opcg8_b_c)=6013.95
     if(p_pcg1_b_o.gt.1)  dhr(p_pcg1_b_o) =6013.95
     if(p_pcg2_b_o.gt.1)  dhr(p_pcg2_b_o) =6013.95
     if(p_pcg3_b_o.gt.1)  dhr(p_pcg3_b_o)=6013.95
     if(p_pcg4_b_o.gt.1)  dhr(p_pcg4_b_o)=6013.95
     if(p_pcg5_b_o.gt.1)  dhr(p_pcg5_b_o)=6013.95
     if(p_pcg6_b_o.gt.1)  dhr(p_pcg6_b_o)=6013.95
     if(p_pcg7_b_o.gt.1)  dhr(p_pcg7_b_o)=6013.95
     if(p_pcg8_b_o.gt.1)  dhr(p_pcg8_b_o)=6013.95
     if(p_pcg9_b_o.gt.1)  dhr(p_pcg9_b_o)=6013.95
     if(p_opcg1_b_o.gt.1)  dhr(p_opcg1_b_o) =6013.95
     if(p_opcg2_b_o.gt.1)  dhr(p_opcg2_b_o) =6013.95
     if(p_opcg3_b_o.gt.1)  dhr(p_opcg3_b_o)=6013.95
     if(p_opcg4_b_o.gt.1)  dhr(p_opcg4_b_o)=6013.95
     if(p_opcg5_b_o.gt.1)  dhr(p_opcg5_b_o)=6013.95
     if(p_opcg6_b_o.gt.1)  dhr(p_opcg6_b_o)=6013.95
     if(p_opcg7_b_o.gt.1)  dhr(p_opcg7_b_o)=6013.95
     if(p_opcg8_b_o.gt.1)  dhr(p_opcg8_b_o)=6013.95
     if(p_pcg1_f_c.gt.1)  dhr(p_pcg1_f_c) =6013.95
     if(p_pcg2_f_c.gt.1)  dhr(p_pcg2_f_c) =6013.95
     if(p_pcg3_f_c.gt.1)  dhr(p_pcg3_f_c)=6013.95
     if(p_pcg4_f_c.gt.1)  dhr(p_pcg4_f_c)=6013.95
     if(p_pcg5_f_c.gt.1)  dhr(p_pcg5_f_c)=6013.95
     if(p_pcg6_f_c.gt.1)  dhr(p_pcg6_f_c)=6013.95
     if(p_pcg7_f_c.gt.1)  dhr(p_pcg7_f_c)=6013.95
     if(p_pcg8_f_c.gt.1)  dhr(p_pcg8_f_c)=6013.95
     if(p_pcg9_f_c.gt.1)  dhr(p_pcg9_f_c)=6013.95
     if(p_opcg1_f_c.gt.1)  dhr(p_opcg1_f_c) =6013.95
     if(p_opcg2_f_c.gt.1)  dhr(p_opcg2_f_c) =6013.95
     if(p_opcg3_f_c.gt.1)  dhr(p_opcg3_f_c)=6013.95
     if(p_opcg4_f_c.gt.1)  dhr(p_opcg4_f_c)=6013.95
     if(p_opcg5_f_c.gt.1)  dhr(p_opcg5_f_c)=6013.95
     if(p_opcg6_f_c.gt.1)  dhr(p_opcg6_f_c)=6013.95
     if(p_opcg7_f_c.gt.1)  dhr(p_opcg7_f_c)=6013.95
     if(p_opcg8_f_c.gt.1)  dhr(p_opcg8_f_c)=6013.95
     if(p_pcg1_f_o.gt.1)  dhr(p_pcg1_f_o) =6013.95
     if(p_pcg2_f_o.gt.1)  dhr(p_pcg2_f_o) =6013.95
     if(p_pcg3_f_o.gt.1)  dhr(p_pcg3_f_o)=6013.95
     if(p_pcg4_f_o.gt.1)  dhr(p_pcg4_f_o)=6013.95
     if(p_pcg5_f_o.gt.1)  dhr(p_pcg5_f_o)=6013.95
     if(p_pcg6_f_o.gt.1)  dhr(p_pcg6_f_o)=6013.95
     if(p_pcg7_f_o.gt.1)  dhr(p_pcg7_f_o)=6013.95
     if(p_pcg8_f_o.gt.1)  dhr(p_pcg8_f_o)=6013.95
     if(p_pcg9_f_o.gt.1)  dhr(p_pcg9_f_o)=6013.95
     if(p_opcg1_f_o.gt.1)  dhr(p_opcg1_f_o) =6013.95
     if(p_opcg2_f_o.gt.1)  dhr(p_opcg2_f_o) =6013.95
     if(p_opcg3_f_o.gt.1)  dhr(p_opcg3_f_o)=6013.95
     if(p_opcg4_f_o.gt.1)  dhr(p_opcg4_f_o)=6013.95
     if(p_opcg5_f_o.gt.1)  dhr(p_opcg5_f_o)=6013.95
     if(p_opcg6_f_o.gt.1)  dhr(p_opcg6_f_o)=6013.95
     if(p_opcg7_f_o.gt.1)  dhr(p_opcg7_f_o)=6013.95
     if(p_opcg8_f_o.gt.1)  dhr(p_opcg8_f_o)=6013.95
     if(p_ant1_c.gt.1)     dhr(p_ant1_c)=6013.95
     if(p_ant2_c.gt.1)     dhr(p_ant2_c)=6013.95
     if(p_ant3_c.gt.1)     dhr(p_ant3_c)=6013.95
     if(p_ant4_c.gt.1)     dhr(p_ant4_c)=6013.95
     if(p_ant1_o.gt.1)     dhr(p_ant1_o)=6013.95
     if(p_ant2_o.gt.1)     dhr(p_ant2_o)=6013.95
     if(p_ant3_o.gt.1)     dhr(p_ant3_o)=6013.95
     if(p_ant4_o.gt.1)     dhr(p_ant4_o)=6013.95
     if(p_biog1_c.gt.1)    dhr(p_biog1_c)=6013.95
     if(p_biog2_c.gt.1)    dhr(p_biog2_c)=6013.95
     if(p_biog3_c.gt.1)    dhr(p_biog3_c)=6013.95
     if(p_biog4_c.gt.1)    dhr(p_biog4_c)=6013.95
     if(p_biog1_o.gt.1)    dhr(p_biog1_o)=6013.95
     if(p_biog2_o.gt.1)    dhr(p_biog2_o)=6013.95
     if(p_biog3_o.gt.1)    dhr(p_biog3_o)=6013.95
     if(p_biog4_o.gt.1)    dhr(p_biog4_o)=6013.95
