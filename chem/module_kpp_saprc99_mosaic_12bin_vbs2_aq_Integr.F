...
! 
! File                 : saprc99_mosaic_12bin_vbs2_aq_Integrator.f90
...
#ifdef FULL_ALGEBRA    
     CALL saprc99_mosaic_12bin_vbs2_aq_WCOPY(NVAR*NVAR,Jac0,1,Ghimj,1)
     CALL saprc99_mosaic_12bin_vbs2_aq_WSCAL(NVAR*NVAR,(-ONE),Ghimj,1)
...
#ifdef FULL_ALGEBRA    
   CALL  saprc99_mosaic_12bin_vbs2_aq_DGETRF( NVAR, NVAR, A, NVAR, Pivot, ising )
#else   
...
#ifdef FULL_ALGEBRA    
   CALL  saprc99_mosaic_12bin_vbs2_aq_DGETRS( 'N', NVAR , 1, A, NVAR, Pivot, b, NVAR, 0 )
#else   
...
!!    CALL Update_RCONST()
#ifdef FULL_ALGEBRA    
    CALL saprc99_mosaic_12bin_vbs2_aq_Jac_SP(Y, FIX, RCONST, JV)
    DO j=1,NVAR
      DO i=1,NVAR
         Jcb(i,j) = 0.0d0
      END DO
...
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! saprc99_mosaic_12bin_vbs2_aq_Fun - time derivatives of variables - Agregate form
!   Arguments :
...
! End of saprc99_mosaic_12bin_vbs2_aq_Fun function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~


! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! saprc99_mosaic_12bin_vbs2_aq_IRRFun - accumulated time derivatives of variables - Agregate form
!   Arguments :
!      V         - Concentrations of variable species (local)
!      F         - Concentrations of fixed species (local)
!      RCT       - Rate constants (local)
...
! End of saprc99_mosaic_12bin_vbs2_aq_IRRFun function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~


! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! saprc99_mosaic_12bin_vbs2_aq_Jac_SP - the Jacobian of Variables in sparse matrix representation
!   Arguments :
!      V         - Concentrations of variable species (local)
!      F         - Concentrations of fixed species (local)
!      RCT       - Rate constants (local)
...
! End of saprc99_mosaic_12bin_vbs2_aq_Jac_SP function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! saprc99_mosaic_12bin_vbs2_aq_KppSolve - sparse back substitution
!   Arguments :
!      JVS       - sparse Jacobian of variables
...
! End of saprc99_mosaic_12bin_vbs2_aq_KppSolve function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
