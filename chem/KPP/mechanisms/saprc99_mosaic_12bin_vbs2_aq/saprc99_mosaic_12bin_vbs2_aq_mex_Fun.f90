...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 USE saprc99_mosaic_12bin_vbs2_aq_Model

      INTEGER nlhs, nrhs
      INTEGER plhs(*), prhs(*)
      INTEGER mxGetPr, mxCreateFull, mxGetM, mxgetN
      INTEGER VPtr, FPtr, RPtr, VdotPtr
      REAL(kind=dp) V(101), F(2), RCT(259)
      REAL(kind=dp) Vdot(101)
...
! Check for the right number of output arguments
     ...
     &Vdot(101)')
      ...
      plhs(1) = mxCreateDoubleMatrix(101,1,0)

      VPtr = mxGetPr(prhs(1))
      CALL mxCopyPtrToReal8(VPtr,V,101)
      ...
      CALL mxCopyReal8ToPtr(Vdot, VdotPtr, 101)
