...
! 
! File                 : saprc99_mosaic_12bin_vbs2_aq_Monitor.f90
...
MODULE saprc99_mosaic_12bin_vbs2_aq_Monitor
  ...
  CHARACTER(LEN=12), PARAMETER, DIMENSION(90) :: SPC_NAMES_0 = (/ &
     ...
     'O3P         ','RCHO        ','MEK         ', &
     'PROD2       ','O3          ','CCO_O2      ' /)
  CHARACTER(LEN=12), PARAMETER, DIMENSION(13) :: SPC_NAMES_1 = (/ &
     'BZCO_O2     ','RCO_O2      ','NO2         ', &
     'NO3         ','OH          ','NO          ', &
     'HO2         ','C_O2        ','RO2_R       ', &
     'MA_RCO3     ','RO2_N       ','H2O         ', &
     'M           ' /)
  CHARACTER(LEN=12), PARAMETER, DIMENSION(103) :: SPC_NAMES = (/&
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_4 = (/ &
     ...
     '             ACET --> CCO_O2 + C_O2                                                                 ', &
     '         MEK + OH --> PSD1 + 0.616 R2O2 + 0.482 CCHO + 0.115 HCHO + 0.37 RCHO + 0.492 CCO_O2 + 0.096', &
     '              MEK --> CCHO + CCO_O2 + RO2_R                                                         ', &
     '        MEOH + OH --> PSD1 + HCHO + HO2                                                             ', &
     '        ETOH + OH --> PSD1 + 0.96 CCHO + 0.081 HCHO + 0.95 HO2 + 0.05 RO2_R                         ', &
     '        COOH + OH --> PSD1 + 0.35 HCHO + 0.35 OH + 0.65 C_O2                                        ', &
     '             COOH --> HCHO + OH + HO2                                                               ', &
     '        ROOH + OH --> PSD1 + RCHO + 0.66 OH + 0.34 RO2_R                                            ', &
     '             ROOH --> RCHO + OH + HO2                                                               ', &
     '              GLY --> 2 CO + 2 HO2                                                                  ', &
     '              GLY --> CO + HCHO                                                                     ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_5 = (/ &
     ...
     '   METHACRO + O3P --> RCHO                                                                          ', &
     '         METHACRO --> 0.67 CO + 0.67 HCHO + 0.67 CCO_O2 + 0.33 OH + 0.34 HO2 + 0.33 RO2_R + 0.33 MA_', &
     ...
     '            PROD2 --> 0.515 R2O2 + 0.246 CCHO + 0.506 HCHO + 0.71 RCHO + 0.667 CCO_O2 + 0.333 RCO_O2', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_6 = (/ &
     ...
     '             DCB2 --> 0.5 MGLY + CO + R2O2 + 0.5 GLY + 0.5 CCO_O2 + 0.5 HO2 + RO2_R                 ', &
     '        DCB3 + OH --> PSD1 + R2O2 + RCHO + CCO_O2                                                   ', &
     '             DCB3 --> 0.5 MGLY + CO + R2O2 + 0.5 GLY + 0.5 CCO_O2 + 0.5 HO2 + RO2_R                 ', &
     '         CH4 + OH --> PSD1 + C_O2                                                                   ', &
     ...
     '   ISOPRENE + O3P --> 0.24 R2O2 + 0.24 HCHO + 0.75 PROD2 + 0.25 C_O2 + 0.24 MA_RCO3 + 0.01 RO2_N    ', &
     ...
     '        C2H2 + OH --> 0.297 HCOOH + PSD1 + 0.393 CO + 0.607 GLY + 0.096 HCHO + 0.603 OH + 0.297 HO2 ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_7 = (/ &
     ...
     '    ISOPRENE + OH --> BIOG1_o + ISOPRENE + OH                                                       ', &
     '    ISOPRENE + O3 --> BIOG1_o + ISOPRENE + O3                                                       ', &
     '   ISOPRENE + NO3 --> 0.0327 BIOG1_o + ISOPRENE + NO3                                               ', &
     '        TERP + OH --> BIOG1_c + TERP + OH                                                           ', &
     '        TERP + O3 --> BIOG2_c + TERP + O3                                                           ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(19) :: EQN_NAMES_8 = (/ &
     '       TERP + NO3 --> 0.0545 BIOG1_o + TERP + NO3                                                   ', &
     '        SESQ + OH --> BIOG1_o + SESQ + OH                                                           ', &
     '        SESQ + O3 --> BIOG1_o + SESQ + O3                                                           ', &
     '       SESQ + NO3 --> 0.0816 BIOG1_o + SESQ + NO3                                                   ', &
     ...
     '        DMS + NO3 --> SO2 + HNO3                                                                    ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(259) :: EQN_NAMES = (/&
...
END MODULE saprc99_mosaic_12bin_vbs2_aq_Monitor
