...
! 
! File                 : saprc99_mosaic_4bin_iepox_vbs_aq_Monitor.f90
...
MODULE saprc99_mosaic_4bin_iepox_vbs_aq_Monitor
  ...
  CHARACTER(LEN=12), PARAMETER, DIMENSION(90) :: SPC_NAMES_0 = (/ &
     ...
     'RCO_OOH     ','XN          ','XC          ', &
     'NUME        ','DEN         ','ANT1_c      ', &
     'ANT2_o      ','ANT3_o      ','BIOG1_c     ', &
     'BIOG1_o     ','PSD1        ','ISOP2O2     ', &
     'IEPOX       ','TETROL      ','OPCG2_F_O   ', &
     'OPCG1_B_O   ','OPCG2_B_O   ','OPCG3_B_O   ', &
     'OPCG4_B_O   ','PCG7_B_C    ','OPCG5_B_O   ', &
     'OPCG6_B_O   ','OPCG7_B_O   ','PCG7_B_O    ', &
     'O1D         ','CH4         ','ISOPOOH     ', &
     'ISOPOO      ','C2H6        ','PCG7_F_C    ', &
     'OPCG3_F_O   ','OPCG4_F_O   ','OPCG5_F_O   ', &
     'OPCG6_F_O   ','PAN         ','PAN2        ', &
     'PBZN        ','MA_PAN      ','BIOG2_c     ', &
     'BIOG4_c     ','BIOG3_c     ','H2O2        ', &
     'ANT2_c      ','ANT3_c      ','ANT4_c      ', &
     'BIOG2_o     ','BIOG3_o     ','BIOG4_o     ', &
     'ETOH        ','C3H8        ','BACL        ', &
     'N2O5        ','SO2         ','HONO        ', &
     'DMS         ','ALK5        ','ALK3        ', &
     'TBU_O       ','COOH        ','HOCOO       ', &
     ...
     'ETHENE      ','ACET        ','C3H6        ', &
     'GLY         ','BZ_O        ','OLE1        ' /)
  CHARACTER(LEN=12), PARAMETER, DIMENSION(30) :: SPC_NAMES_1 = (/ &
     'TERP        ','R2O2        ','SESQ        ', &
     'ISOPRENE    ','METHACRO    ','ISOPROD     ', &
     'CCHO        ','OLE2        ','MVK         ', &
     'HCHO        ','RNO3        ','O3P         ', &
     'RCHO        ','MEK         ','PROD2       ', &
     'O3          ','RO2_R       ','RCO_O2      ', &
     ...
     'NO          ','MA_RCO3     ','BZCO_O2     ', &
     'NO3         ','H2O         ','M           ' /)
  CHARACTER(LEN=12), PARAMETER, DIMENSION(120) :: SPC_NAMES = (/&
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_1 = (/ &
     ...
     '        NO2 + HO2 --> HNO4                                                                          ', &
     '             HNO4 --> NO2 + HO2                                                                     ', &
     '             HNO4 --> 0.61 NO2 + 0.61 HO2 + 0.39 OH + 0.39 NO3                                      ', &
     '        HNO4 + OH --> NO2                                                                           ', &
     '         O3 + HO2 --> OH                                                                            ', &
     '            2 HO2 --> H2O2                                                                          ', &
     '      2 HO2 + H2O --> H2O2                                                                          ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_2 = (/ &
     ...
     '     RCO_O2 + NO3 --> CCHO + RO2_R + NO2                                                            ', &
     '    RCO_O2 + C_O2 --> RCO_OH + HCHO                                                                 ', &
     '   RO2_R + RCO_O2 --> RCO_OH                                                                        ', &
     '    R2O2 + RCO_O2 --> RCO_O2                                                                        ', &
     '   RCO_O2 + RO2_N --> RCO_OH + PROD2                                                                ', &
     '  RCO_O2 + CCO_O2 --> CCHO + RO2_R + C_O2                                                           ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_4 = (/ &
     ...
     '        RCHO + OH --> 0.034 CO + 0.034 CCHO + 0.034 RO2_R + 0.965 RCO_O2 + 0.001 RO2_N              ', &
     '             RCHO --> CO + CCHO + RO2_R + HO2                                                       ', &
     '       RCHO + NO3 --> HNO3 + RCO_O2                                                                 ', &
     '        ACET + OH --> R2O2 + HCHO + CCO_O2                                                          ', &
     '             ACET --> C_O2 + CCO_O2                                                                 ', &
     '         MEK + OH --> 0.616 R2O2 + 0.482 CCHO + 0.115 HCHO + 0.37 RCHO + 0.37 RO2_R + 0.096 RCO_O2 +', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_5 = (/ &
     ...
     '    METHACRO + OH --> 0.084 MGLY + 0.416 CO + 0.084 HCHO + 0.416 MEK + 0.5 RO2_R + 0.5 MA_RCO3      ', &
     '    METHACRO + O3 --> 0.333 HCOOH + 0.9 MGLY + 0.45 CO + 0.2 HCHO + 0.1 RO2_R + 0.1 RCO_O2 + 0.008 H', &
     '   METHACRO + NO3 --> 0.5 CO + 0.5 HNO3 + 0.5 RO2_R + 0.5 MA_RCO3                                   ', &
     '   METHACRO + O3P --> RCHO                                                                          ', &
     '         METHACRO --> 0.67 CO + 0.67 HCHO + 0.33 RO2_R + 0.67 CCO_O2 + 0.34 HO2 + 0.33 OH + 0.33 MA_', &
     '         MVK + OH --> 0.3 MGLY + 0.675 R2O2 + 0.3 HCHO + 0.675 RCHO + 0.3 RO2_R + 0.675 CCO_O2 + 0.0', &
     '         MVK + O3 --> 0.351 HCOOH + 0.95 MGLY + 0.475 CO + 0.1 HCHO + 0.05 RO2_R + 0.05 RCO_O2 + 0.0', &
     ...
     '       PROD2 + OH --> 0.084 CCHO + 0.213 HCHO + 0.558 RCHO + 0.115 MEK + 0.329 PROD2 + 0.473 RO2_R +', &
     '            PROD2 --> 0.515 R2O2 + 0.246 CCHO + 0.506 HCHO + 0.71 RCHO + 0.96 RO2_R + 0.333 RCO_O2 +', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_6 = (/ &
     ...
     '             DCB2 --> 0.5 MGLY + CO + 0.5 GLY + R2O2 + RO2_R + 0.5 CCO_O2 + 0.5 HO2                 ', &
     '        DCB3 + OH --> R2O2 + RCHO + CCO_O2                                                          ', &
     '             DCB3 --> 0.5 MGLY + CO + 0.5 GLY + R2O2 + RO2_R + 0.5 CCO_O2 + 0.5 HO2                 ', &
     '         CH4 + OH --> C_O2                                                                          ', &
     ...
     '        TERP + OH --> 0.5 R2O2 + 0.276 HCHO + 0.474 RCHO + 0.276 PROD2 + 0.75 RO2_R + 0.25 RO2_N    ', &
     ...
     '        SESQ + OH --> 0.5 R2O2 + 0.276 HCHO + 0.474 RCHO + 0.276 PROD2 + 0.75 RO2_R + 0.25 RO2_N    ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_7 = (/ &
     '        C2H6 + OH --> CCHO + RO2_R                                                                  ', &
     '        C3H8 + OH --> 0.704 ACET + 0.261 RCHO + 0.965 RO2_R + 0.035 RO2_N                           ', &
     '        C2H2 + OH --> 0.297 HCOOH + 0.393 CO + 0.607 GLY + 0.096 HCHO + 0.1 RO2_R + 0.297 HO2 + 0.60', &
     ...
     '        C3H6 + OH --> 0.048 XC + 0.984 CCHO + 0.984 HCHO + 0.984 RO2_R + 0.016 RO2_N                ', &
     ...
     '    ISOPRENE + OH --> BIOG4_c + ISOPRENE + OH                                                       ', &
     '        TERP + OH --> BIOG2_o + TERP + OH                                                           ', &
     '        TERP + OH --> BIOG3_o + TERP + OH                                                           ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_8 = (/ &
     '        TERP + OH --> BIOG4_o + TERP + OH                                                           ', &
     '        SESQ + OH --> ANT2_c + SESQ + OH                                                            ', &
     '        SESQ + OH --> ANT3_c + SESQ + OH                                                            ', &
     '    ISOPRENE + O3 --> BIOG3_c + ISOPRENE + O3                                                       ', &
     '        TERP + O3 --> BIOG1_o + TERP + O3                                                           ', &
     '        TERP + O3 --> BIOG2_o + TERP + O3                                                           ', &
     '        TERP + O3 --> BIOG3_o + TERP + O3                                                           ', &
     '        TERP + O3 --> BIOG4_o + TERP + O3                                                           ', &
     '        SESQ + O3 --> ANT1_c + SESQ + O3                                                            ', &
     '        SESQ + O3 --> ANT2_c + SESQ + O3                                                            ', &
     '        SESQ + O3 --> ANT3_c + SESQ + O3                                                            ', &
     '   ISOPRENE + NO3 --> BIOG2_c + ISOPRENE + NO3                                                      ', &
     '   ISOPRENE + NO3 --> BIOG3_c + ISOPRENE + NO3                                                      ', &
     '   ISOPRENE + NO3 --> BIOG4_c + ISOPRENE + NO3                                                      ', &
     '       TERP + NO3 --> BIOG1_o + TERP + NO3                                                          ', &
     '       TERP + NO3 --> BIOG2_o + TERP + NO3                                                          ', &
     '       TERP + NO3 --> BIOG4_o + TERP + NO3                                                          ', &
     '       SESQ + NO3 --> ANT1_c + SESQ + NO3                                                           ', &
     '       SESQ + NO3 --> ANT2_c + SESQ + NO3                                                           ', &
     '       SESQ + NO3 --> ANT4_c + SESQ + NO3                                                           ', &
     '    PCG7_F_C + OH --> 0.044 OPCG2_F_O + 0.071 OPCG3_F_O + 0.41 OPCG4_F_O + 0.3 OPCG5_F_O + OH       ', &
     '   OPCG6_F_O + OH --> OPCG5_F_O + OH                                                                ', &
     '   OPCG6_F_O + OH --> OPCG6_F_O + OH                                                                ', &
     '   OPCG5_F_O + OH --> OPCG4_F_O + OH                                                                ', &
     '   OPCG5_F_O + OH --> OPCG6_F_O + OH                                                                ', &
     '   OPCG4_F_O + OH --> OPCG3_F_O + OH                                                                ', &
     '   OPCG4_F_O + OH --> OPCG6_F_O + OH                                                                ', &
     '   OPCG3_F_O + OH --> OPCG2_F_O + OH                                                                ', &
     '   OPCG3_F_O + OH --> OPCG6_F_O + OH                                                                ', &
     '     BIOG4_c + OH --> BIOG3_c + OH                                                                  ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(19) :: EQN_NAMES_9 = (/ &
     '     BIOG4_c + OH --> BIOG4_c + OH                                                                  ', &
     '     BIOG3_c + OH --> BIOG2_c + OH                                                                  ', &
     '     BIOG3_c + OH --> BIOG4_c + OH                                                                  ', &
     '     BIOG2_c + OH --> BIOG1_c + OH                                                                  ', &
     '     BIOG2_c + OH --> BIOG4_c + OH                                                                  ', &
     '     BIOG4_o + OH --> BIOG3_o + OH                                                                  ', &
     '     BIOG4_o + OH --> BIOG4_o + OH                                                                  ', &
     '     BIOG3_o + OH --> BIOG2_o + OH                                                                  ', &
     '     BIOG3_o + OH --> BIOG4_o + OH                                                                  ', &
     '     BIOG2_o + OH --> BIOG1_o + OH                                                                  ', &
     '     BIOG2_o + OH --> BIOG4_o + OH                                                                  ', &
     '      ANT4_c + OH --> ANT3_c + OH                                                                   ', &
     '      ANT4_c + OH --> ANT4_c + OH                                                                   ', &
     '      ANT3_c + OH --> ANT2_c + OH                                                                   ', &
     '      ANT3_c + OH --> ANT4_c + OH                                                                   ', &
     '      ANT2_c + OH --> ANT1_c + OH                                                                   ', &
     '      ANT2_c + OH --> ANT4_c + OH                                                                   ', &
     '    PCG7_B_C + OH --> 0.005757 OPCG1_B_O + 0.074142 OPCG2_B_O + 0.132523 OPCG3_B_O + 0.478008 OPCG4_', &
     '    PCG7_B_O + OH --> 0.081486 OPCG5_B_O + 0.5 OPCG6_B_O + 0.312248 OPCG7_B_O + OH                  ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(289) :: EQN_NAMES = (/&
...
END MODULE saprc99_mosaic_4bin_iepox_vbs_aq_Monitor
