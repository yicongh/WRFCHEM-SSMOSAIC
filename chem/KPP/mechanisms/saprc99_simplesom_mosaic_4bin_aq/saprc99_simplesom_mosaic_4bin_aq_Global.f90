...
! 
! File                 : saprc99_simplesom_mosaic_4bin_aq_Global.f90
...
MODULE saprc99_simplesom_mosaic_4bin_aq_Global

  USE saprc99_simplesom_mosaic_4bin_aq_Parameters, ONLY: dp, NSPEC, NVAR, NFIX, NREACT
  PUBLIC
  SAVE
...
END MODULE saprc99_simplesom_mosaic_4bin_aq_Global
