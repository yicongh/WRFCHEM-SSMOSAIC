...
MODULE saprc99_mosaic_8bin_vbs2_aq_Monitor
  ...
  CHARACTER(LEN=12), PARAMETER, DIMENSION(90) :: SPC_NAMES_0 = (/ &
     ...
     'RNO3        ','O3P         ','RCHO        ', &
     'MEK         ','PROD2       ','O3          ', &
     'RO2_N       ','RCO_O2      ','MA_RCO3     ' /)
  CHARACTER(LEN=12), PARAMETER, DIMENSION(11) :: SPC_NAMES_1 = (/ &
     'HO2         ','NO2         ','C_O2        ', &
     'RO2_R       ','BZCO_O2     ','CCO_O2      ', &
     'NO          ','OH          ','NO3         ', &
     'H2O         ','M           ' /)
  CHARACTER(LEN=12), PARAMETER, DIMENSION(101) :: SPC_NAMES = (/&
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_1 = (/ &
     ...
     '           OH + M --> PSD1 + HO2                                                                    ', &
     '        C_O2 + NO --> NUME + HCHO + HO2 + NO2                                                       ', &
     '       HO2 + C_O2 --> DEN + COOH                                                                    ', &
     '       C_O2 + NO3 --> NUME + HCHO + HO2 + NO2                                                       ', &
     '           2 C_O2 --> DEN + MEOH + HCHO                                                             ', &
     '           2 C_O2 --> DEN + 2 HCHO + 2 HO2                                                          ', &
     '       RO2_R + NO --> NUME + HO2 + NO2                                                              ', &
     '      HO2 + RO2_R --> DEN + ROOH                                                                    ', &
     '      RO2_R + NO3 --> NUME + HO2 + NO2                                                              ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_4 = (/ &
     ...
     '        RCHO + OH --> PSD1 + 0.034 CO + 0.034 CCHO + 0.001 RO2_N + 0.965 RCO_O2 + 0.034 RO2_R       ', &
     '             RCHO --> CO + CCHO + HO2 + RO2_R                                                       ', &
     '       RCHO + NO3 --> HNO3 + RCO_O2                                                                 ', &
     '        ACET + OH --> PSD1 + R2O2 + HCHO + CCO_O2                                                   ', &
     '             ACET --> C_O2 + CCO_O2                                                                 ', &
     '         MEK + OH --> PSD1 + 0.616 R2O2 + 0.482 CCHO + 0.115 HCHO + 0.37 RCHO + 0.042 RO2_N + 0.096 ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_5 = (/ &
     ...
     '   METHACRO + O3P --> RCHO                                                                          ', &
     '         METHACRO --> 0.67 CO + 0.67 HCHO + 0.33 MA_RCO3 + 0.34 HO2 + 0.33 RO2_R + 0.67 CCO_O2 + 0.3', &
     '         MVK + OH --> PSD1 + 0.3 MGLY + 0.675 R2O2 + 0.3 HCHO + 0.675 RCHO + 0.025 RO2_N + 0.3 RO2_R', &
     ...
     '       PROD2 + OH --> PSD1 + 0.084 CCHO + 0.213 HCHO + 0.558 RCHO + 0.115 MEK + 0.329 PROD2 + 0.07 R', &
     '            PROD2 --> 0.515 R2O2 + 0.246 CCHO + 0.506 HCHO + 0.71 RCHO + 0.04 RO2_N + 0.333 RCO_O2 +', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_6 = (/ &
     ...
     '        TERP + OH --> PSD1 + 0.5 R2O2 + 0.276 HCHO + 0.474 RCHO + 0.276 PROD2 + 0.25 RO2_N + 0.75 RO', &
     ...
     '        SESQ + OH --> PSD1 + 0.5 R2O2 + 0.276 HCHO + 0.474 RCHO + 0.276 PROD2 + 0.25 RO2_N + 0.75 RO', &
     '        SESQ + O3 --> 0.103 HCOOH + 0.189 RCO_OH + 0.031 BACL + 0.157 CO + 0.13 ACET + 0.729 R2O2 + ', &
     '       SESQ + NO3 --> 0.75 R2O2 + 0.276 RNO3 + 0.474 RCHO + 0.25 RO2_N + 0.474 NO2 + 0.276 RO2_R    ', &
     '       SESQ + O3P --> 0.147 RCHO + 0.853 PROD2                                                      ', &
     '        C2H6 + OH --> PSD1 + CCHO + RO2_R                                                           ', &
     '        C3H8 + OH --> PSD1 + 0.704 ACET + 0.261 RCHO + 0.035 RO2_N + 0.965 RO2_R                    ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_7 = (/ &
     ...
     '        C3H6 + OH --> 0.048 XC + PSD1 + 0.984 CCHO + 0.984 HCHO + 0.016 RO2_N + 0.984 RO2_R         ', &
