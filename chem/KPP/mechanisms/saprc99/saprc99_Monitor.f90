...
MODULE saprc99_Monitor
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_1 = (/ &
     ...
     '      RO2_R + HO2 --> ROOH                                                                          ', &
     '      RO2_R + NO3 --> NO2 + HO2                                                                     ', &
     '     RO2_R + C_O2 --> 0.25 MEOH + 0.75 HCHO + HO2                                                   ', &
     '          2 RO2_R --> HO2                                                                           ', &
     '        R2O2 + NO --> NO2                                                                           ', &
     '       R2O2 + HO2 --> HO2                                                                           ', &
     '       R2O2 + NO3 --> NO2                                                                           ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_2 = (/ &
     ...
     '       NO + RO2_N --> RNO3                                                                          ', &
     '      HO2 + RO2_N --> ROOH                                                                          ', &
     '     C_O2 + RO2_N --> 0.25 MEOH + 0.75 HCHO + 0.5 MEK + 0.5 PROD2 + HO2                             ', &
     '      NO3 + RO2_N --> MEK + NO2 + HO2                                                               ', &
     '    RO2_R + RO2_N --> 0.5 MEK + 0.5 PROD2 + HO2                                                     ', &
     '     R2O2 + RO2_N --> RO2_N                                                                         ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_4 = (/ &
     ...
     '             ACET --> CCO_O2 + C_O2                                                                 ', &
     '         MEK + OH --> 0.616 R2O2 + 0.482 CCHO + 0.115 HCHO + 0.37 RCHO + 0.492 CCO_O2 + 0.37 RO2_R +', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_5 = (/ &
     ...
     '    METHACRO + O3 --> 0.333 HCOOH + 0.9 MGLY + 0.45 CO + 0.2 HCHO + 0.1 RO2_R + 0.208 OH + 0.1 RCO_O', &
     ...
     '         MVK + OH --> 0.3 MGLY + 0.675 R2O2 + 0.3 HCHO + 0.675 RCHO + 0.675 CCO_O2 + 0.3 RO2_R + 0.0', &
     '         MVK + O3 --> 0.351 HCOOH + 0.95 MGLY + 0.475 CO + 0.1 HCHO + 0.05 RO2_R + 0.164 OH + 0.05 R', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_6 = (/ &
     ...
     '      ISOPOO + NO --> NO                                                                            ', &
     '         2 ISOPOO --> PSD1                                                                          ', &
     '     ISOPOOH + OH --> 0.75 IEPOX + 0.12 ISOP2O2 + 0.13 ISOPOO + OH                                  ', &
     '       IEPOX + OH --> PSD1 + OH                                                                     ', &
     ...
     '        C2H2 + OH --> 0.297 HCOOH + 0.393 CO + 0.607 GLY + 0.096 HCHO + 0.1 RO2_R + 0.603 OH + 0.297', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(20) :: EQN_NAMES_7 = (/ &
     ...
     '        ARO1 + OH --> 0.051 DCB3 + 0.108 DCB2 + 0.207 CRES + 0.491 DCB1 + 0.059 BALD + 0.017 PHEN + ', &
     '        ARO2 + OH --> 0.087 BACL + 0.093 DCB3 + 0.099 DCB2 + 0.187 CRES + 0.561 DCB1 + 0.05 BALD + 0', &
