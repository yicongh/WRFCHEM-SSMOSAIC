...
! 
! File                 : saprc99_mosaic_8bin_vbs2_Global.f90
...
MODULE saprc99_mosaic_8bin_vbs2_Global

  USE saprc99_mosaic_8bin_vbs2_Parameters, ONLY: dp, NSPEC, NVAR, NFIX, NREACT
  PUBLIC
  SAVE
...
END MODULE saprc99_mosaic_8bin_vbs2_Global
