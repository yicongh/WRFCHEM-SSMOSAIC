...
900   continue
     ...
     return
      ...
      use module_data_mosaic_aero, only: &
         ...
         jglysoa_oh,                                    &
         jiepox,     jgly,       jiepoxos,   jtetrol,    &
         jtanv,      jsopnv,     jternv,     jseqnv,     &
         jsianv
      ...
      iiepox_a      = 102 ;  iiepox_g     =102;   jiepox     =122
      igly_a         =103 ;  igly_g       =103;   jgly       =123
      ...
      iglysoa_r1_a  = 111 ;                       jglysoa_r1 =131
      iglysoa_r2_a  = 112 ;                       jglysoa_r2 =132
      iglysoa_sfc_a = 113 ;                       jglysoa_sfc=133
      iglysoa_nh4_a = 114 ;                       jglysoa_nh4=134
      iglysoa_oh_a  = 115 ;                       jglysoa_oh =135
