   ...
   USE module_mosaic_driver, only: drive_MOSAIC0 
   USE mod_SSMOSAIC, only: drive_SSMOSAIC
   ...
   REAL, DIMENSION( ims:ime, kms:kme, jms:jme ),                    &
         INTENT(INOUT ) ::                                          &
           ...
           cvalk1,cvole1,cvapi1,cvapi2,cvlim1,cvlim2,brch_ratio,phw_bin1,phw_bin2,phw_bin3,phw_bin4, &
           gammaaq,gammacld,clddropdia,betaaq,betacld,coatbin1,coatbin2,coatbin3,coatbin4
   ...
   CASE (SAPRC99_SIMPLESOM_MOSAIC_4BIN_AQ_KPP)
       ...
       CALL drive_SSMOSAIC(CHEM,ids,ide, jds,jde, kds,kde, &
                                ims,ime, jms,jme, kms,kme, &
                                its,ite, jts,jte, kts,kte, dtstep)
   ...
   CASE (CBMZ_MOSAIC_4BIN, CBMZ_MOSAIC_KPP, CBMZ_MOSAIC_8BIN, CBMZ_MOSAIC_4BIN_AQ, &
       ...
       CALL drive_MOSAIC0(                                      &
            ...
            ph_no2,                                                     &
            gammaaq,gammacld,clddropdia,betaaq,betacld,coatbin1,        &
   ...
   USE module_mosaic_sumpm, only: sum_pm_mosaic,sum_pm_mosaic_vbs2,sum_pm_mosaic_vbs0,sum_pm_mosaic_vbs4,&
                                   sum_vbs9,sum_vbs2,sum_vbs0,sum_vbs4,sum_aq_vbs2, &
                                   sum_iepox_vbs,sum_iepox_vbs_aq,sum_pm_mosaic_iepox_vbs
   ...
   CASE (MOZART_MOSAIC_4BIN_AQ_KPP)
    ...
    CASE (SAPRC99_MOSAIC_8BIN_VBS2_AQ_KPP,SAPRC99_MOSAIC_8BIN_VBS2_KPP)
      ...
      CASE (SAPRC99_MOSAIC_4BIN_IEPOX_VBS_AQ_KPP, SAPRC99_SIMPLESOM_MOSAIC_4BIN_AQ_KPP) 
       ...
       CALL wrf_debug(15,'sum_pm_driver: calling sum_pm_mosaic_iepox_vbs')
       call sum_pm_mosaic_iepox_vbs (                                  &
            alt, chem,                                                 &
            pm2_5_dry, pm2_5_water, pm2_5_dry_ec, pm10,                &
            ids,ide, jds,jde, kds,kde,                                 &
            ims,ime, jms,jme, kms,kme,                                 &
       ...
       CALL wrf_debug(15,'sum_pm_driver: calling sum_iepox_vbs')
       call sum_iepox_vbs (config_flags%aero_diag_opt,                 &
             alt, chem,                                                &
             hoa_a01,hoa_a02,hoa_a03,hoa_a04,                          &
             bboa_a01,bboa_a02,bboa_a03,bboa_a04,                      &
             soa_a01,soa_a02,soa_a03,soa_a04,                          &
       ...
       IF( config_flags%aero_cw_diag_opt == diag_cw_aero ) THEN
       CALL wrf_debug(15,'sum_pm_driver: calling sum_iepox_vbs_aq')
       call sum_iepox_vbs_aq (                                         &
             alt, chem,                                                &
             hoa_cw01,hoa_cw02,hoa_cw03,hoa_cw04,                      &
             bboa_cw01,bboa_cw02,bboa_cw03,bboa_cw04,                  &
             soa_cw01,soa_cw02,soa_cw03,soa_cw04,                      &
    ...
    CASE (SAPRC99_MOSAIC_20BIN_VBS2_AQ_KPP,SAPRC99_MOSAIC_20BIN_VBS2_KPP, &
          SAPRC99_MOSAIC_12BIN_VBS2_AQ_KPP,SAPRC99_MOSAIC_12BIN_VBS2_KPP)  
