      ...
      parameter(ngas_soa = 68+2+16+10+1+1)	    
                                        

      parameter(ngas_volatile = ngas_ioa + ngas_soa+3) 
      parameter(ngas_het = 2)   

      parameter(naer = 5+68+2+16+10+2+2+2+5+5+6)	
      parameter(naercomp = 25+68+2+16+10+2+2+2+5+5+1)	
