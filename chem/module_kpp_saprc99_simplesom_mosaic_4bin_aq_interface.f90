...
MODULE module_kpp_saprc99_simplesom_mosaic_4bin_aq_interf 
  ...
  USE saprc99_simplesom_mosaic_4bin_aq_UpdateRconstWRF
  USE saprc99_simplesom_mosaic_4bin_aq_Integrator
...
SUBROUTINE  saprc99_simplesom_mosaic_4bin_aq_interface( &
   ...
   RCNTRL(3) = 0.01_dp * TIME_END
    ...
    var(ind_TERP_CN3_g) = conv  * REAL( MAX(chem(i,k,j,P_terp_cn3_g),0.), KIND=dp)  
    var(ind_TERP_CN2_g) = conv  * REAL( MAX(chem(i,k,j,P_terp_cn2_g),0.), KIND=dp)  
    var(ind_TERP_CN1_g) = conv  * REAL( MAX(chem(i,k,j,P_terp_cn1_g),0.), KIND=dp)  
    var(ind_TERP_C00_g) = conv  * REAL( MAX(chem(i,k,j,P_terp_c00_g),0.), KIND=dp)  
    var(ind_TERP_C01_g) = conv  * REAL( MAX(chem(i,k,j,P_terp_c01_g),0.), KIND=dp)  
    var(ind_TERP_C02_g) = conv  * REAL( MAX(chem(i,k,j,P_terp_c02_g),0.), KIND=dp)  
    var(ind_TERP_C03_g) = conv  * REAL( MAX(chem(i,k,j,P_terp_c03_g),0.), KIND=dp)  
    var(ind_TERP_C04_g) = conv  * REAL( MAX(chem(i,k,j,P_terp_c04_g),0.), KIND=dp)  
    var(ind_TERP_C05_g) = conv  * REAL( MAX(chem(i,k,j,P_terp_c05_g),0.), KIND=dp)  
    var(ind_TERP_C06_g) = conv  * REAL( MAX(chem(i,k,j,P_terp_c06_g),0.), KIND=dp)  
    var(ind_TERP_C07_g) = conv  * REAL( MAX(chem(i,k,j,P_terp_c07_g),0.), KIND=dp)  
    var(ind_TERP_C08_g) = conv  * REAL( MAX(chem(i,k,j,P_terp_c08_g),0.), KIND=dp)  
    var(ind_TERP_C09_g) = conv  * REAL( MAX(chem(i,k,j,P_terp_c09_g),0.), KIND=dp)  
   ...
   CALL saprc99_simplesom_mosaic_4bin_aq_Update_Rconst(  &
  ...
  CALL saprc99_simplesom_mosaic_4bin_aq_INTEGRATE(TIME_START, TIME_END, &  
   ...
   tbu_o(i,k,j) = MAX (REAL (oconv * var(ind_TBU_O) , KIND=sp),0.) 
    ...
    chem(i,k,j,P_terp_cn3_g) = MAX ( REAL (oconv * var(ind_TERP_CN3_g), KIND=sp), 0.)  
    chem(i,k,j,P_terp_cn2_g) = MAX ( REAL (oconv * var(ind_TERP_CN2_g), KIND=sp), 0.)  
    chem(i,k,j,P_terp_cn1_g) = MAX ( REAL (oconv * var(ind_TERP_CN1_g), KIND=sp), 0.)  
    chem(i,k,j,P_terp_c00_g) = MAX ( REAL (oconv * var(ind_TERP_C00_g), KIND=sp), 0.)  
    chem(i,k,j,P_terp_c01_g) = MAX ( REAL (oconv * var(ind_TERP_C01_g), KIND=sp), 0.)  
    chem(i,k,j,P_terp_c02_g) = MAX ( REAL (oconv * var(ind_TERP_C02_g), KIND=sp), 0.)  
    chem(i,k,j,P_terp_c03_g) = MAX ( REAL (oconv * var(ind_TERP_C03_g), KIND=sp), 0.)  
    chem(i,k,j,P_terp_c04_g) = MAX ( REAL (oconv * var(ind_TERP_C04_g), KIND=sp), 0.)  
    chem(i,k,j,P_terp_c05_g) = MAX ( REAL (oconv * var(ind_TERP_C05_g), KIND=sp), 0.)  
    chem(i,k,j,P_terp_c06_g) = MAX ( REAL (oconv * var(ind_TERP_C06_g), KIND=sp), 0.)  
    chem(i,k,j,P_terp_c07_g) = MAX ( REAL (oconv * var(ind_TERP_C07_g), KIND=sp), 0.)  
    chem(i,k,j,P_terp_c08_g) = MAX ( REAL (oconv * var(ind_TERP_C08_g), KIND=sp), 0.)  
    chem(i,k,j,P_terp_c09_g) = MAX ( REAL (oconv * var(ind_TERP_C09_g), KIND=sp), 0.)  
...
END SUBROUTINE  saprc99_simplesom_mosaic_4bin_aq_interface


END MODULE module_kpp_saprc99_simplesom_mosaic_4bin_aq_interf 
