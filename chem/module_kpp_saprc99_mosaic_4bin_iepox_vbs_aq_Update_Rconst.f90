...
MODULE saprc99_mosaic_4bin_iepox_vbs_aq_UpdateRconstWRF
...
SUBROUTINE saprc99_mosaic_4bin_iepox_vbs_aq_Update_RCONST(  &
...
REAL(KIND=dp), INTENT(IN) ::  nume,den
  ...
  RCONST(141) = (ARR(5.56D-13,-532.0_dp,1.0_dp,TEMP))
  ...
  RCONST(190) = (ARR(2.70D-11,-390.0_dp,0.0_dp,TEMP))
  RCONST(191) = (ARR(2.12D-13,-1300.0_dp,0.0_dp,TEMP))
  RCONST(192) = (ARR(2.70D-12,-350.0_dp,0.0_dp,TEMP))
  RCONST(193) = (1.96D-12)
  RCONST(194) = (ARR(1.90D-11,-390.0_dp,0.0_dp,TEMP))
  RCONST(195) = (ARR(5.82D-11,400.0_dp,0.0_dp,TEMP))
  RCONST(196) = (ARR(5.82D-11,400.0_dp,0.0_dp,TEMP))
  RCONST(197) = (ARR(7.4D-13,-700.0_dp,0.0_dp,TEMP))
  RCONST(198) = (ARR(2.70D-12,-350.0_dp,0.0_dp,TEMP))
  RCONST(199) = (ARR(1.1D12,8660.0_dp,0.0_dp,TEMP))
  RCONST(200) = (ARR(7.86D-15,1912.0_dp,0.0_dp,TEMP))
  RCONST(201) = (ARR(3.03D-12,448.0_dp,0.0_dp,TEMP))
  RCONST(202) = (3.60D-11)
  RCONST(203) = (ARR(1.83D-11,-449.0_dp,0.0_dp,TEMP))
  RCONST(204) = (ARR(1.08D-15,821.0_dp,0.0_dp,TEMP))
  RCONST(205) = (ARR(3.66D-12,-175.0_dp,0.0_dp,TEMP))
  RCONST(206) = (3.27D-11)
  RCONST(207) = (6.80D-11)
  RCONST(208) = (6.21D-17)
  RCONST(209) = (8.29D-12)
  RCONST(210) = (3.27D-11)
  RCONST(211) = (ARR(1.37D-12,498.0_dp,2.0_dp,TEMP))
  RCONST(212) = (ARR(0.0_dp,0.0_dp,1.0_dp,TEMP))
  RCONST(213) = (ARR(9.40D-12,700.0_dp,0.0_dp,TEMP))
  RCONST(214) = (ARR(1.019D-11,434.0_dp,0.0_dp,TEMP))
  RCONST(215) = (ARR(5.946D-12,91.0_dp,0.0_dp,TEMP))
  RCONST(216) = (ARR(1.112D-11,52.0_dp,0.0_dp,TEMP))
  RCONST(217) = (ARR(1.81D-12,-355.0_dp,0.0_dp,TEMP))
  RCONST(218) = (2.640D-11)
  RCONST(219) = (ARR(7.095D-12,-451.0_dp,0.0_dp,TEMP))
  RCONST(220) = (ARR(2.617D-15,1640.0_dp,0.0_dp,TEMP))
  RCONST(221) = (ARR(4.453D-14,376.0_dp,0.0_dp,TEMP))
  RCONST(222) = (ARR(1.074D-11,234.0_dp,0.0_dp,TEMP))
  RCONST(223) = (ARR(1.743D-11,-384.0_dp,0.0_dp,TEMP))
  RCONST(224) = (ARR(5.022D-16,461.0_dp,0.0_dp,TEMP))
  RCONST(225) = (7.265D-13)
  RCONST(226) = (2.085D-11)
  RCONST(227) = (ARR(2.00D-14,4398.0_dp,0.0_dp,TEMP))
  RCONST(228) = (ARR(4.85D-12,-504.0_dp,0.0_dp,TEMP))
  RCONST(229) = (ARR(5.51D-15,1878.0_dp,0.0_dp,TEMP))
  RCONST(230) = (ARR(4.59D-13,1156.0_dp,0.0_dp,TEMP))
  RCONST(231) = (ARR(1.18D-11,324.0_dp,0.0_dp,TEMP))
  RCONST(232) = (ARR2(9.6e-12_dp,234.0_dp,TEMP))
  RCONST(233) = (usr24(TEMP,C_M))
  RCONST(234) = (ARR2(1.9e-13_dp,-520.0_dp,TEMP))
  RCONST(235) = (Keff(2.50D-11,-408.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.0_dp))
  RCONST(236) = (Keff(2.50D-11,-408.0_dp,0.0_dp,TEMP,nume,den,0.00518_dp,0.0_dp))
  RCONST(237) = (Keff(2.50D-11,-408.0_dp,0.0_dp,TEMP,nume,den,0.01717_dp,0.0_dp))
  RCONST(238) = (Keff(2.50D-11,-408.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.0_dp))
  RCONST(239) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.01853_dp,0.14986_dp))
  RCONST(240) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.10845_dp,0.05450_dp))
  RCONST(241) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.09264_dp))
  RCONST(242) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.01020_dp))
  RCONST(243) = (Keff(1.83D-11,-449.0_dp,0.0_dp,TEMP,nume,den,0.99144_dp,0.65688_dp))
  RCONST(244) = (Keff(7.86D-15,1912.0_dp,0.0_dp,TEMP,nume,den,0.0_dp,0.00327_dp))
  RCONST(245) = (Keff(1.08D-15,821.0_dp,0.0_dp,TEMP,nume,den,0.04360_dp,0.04360_dp))
  RCONST(246) = (Keff(1.08D-15,821.0_dp,0.0_dp,TEMP,nume,den,0.01035_dp,0.01035_dp))
  RCONST(247) = (Keff(1.08D-15,821.0_dp,0.0_dp,TEMP,nume,den,0.09809_dp,0.09809_dp))
  RCONST(248) = (Keff(1.08D-15,821.0_dp,0.0_dp,TEMP,nume,den,0.01635_dp,0.01635_dp))
  RCONST(249) = (Keff(1.08D-15,821.0_dp,0.0_dp,TEMP,nume,den,0.01142_dp,0.01142_dp))
  RCONST(250) = (Keff(1.08D-15,821.0_dp,0.0_dp,TEMP,nume,den,0.04243_dp,0.04243_dp))
  RCONST(251) = (Keff(1.08D-15,821.0_dp,0.0_dp,TEMP,nume,den,0.03754_dp,0.03754_dp))
  RCONST(252) = (Keff3(3.03D-12,448.0_dp,0.0_dp,TEMP,0.00027_dp))
  RCONST(253) = (Keff3(3.03D-12,448.0_dp,0.0_dp,TEMP,0.04060_dp))
  RCONST(254) = (Keff3(3.03D-12,448.0_dp,0.0_dp,TEMP,0.06458_dp))
  RCONST(255) = (Keff3(3.66D-12,-175.0_dp,0.0_dp,TEMP,0.203_dp))
  RCONST(256) = (Keff3(3.66D-12,-175.0_dp,0.0_dp,TEMP,0.018_dp))
  RCONST(257) = (Keff3(3.66D-12,-175.0_dp,0.0_dp,TEMP,0.513_dp))
  RCONST(258) = (Keff3(3.66D-12,-175.0_dp,0.0_dp,TEMP,0.304_dp))
  RCONST(259) = (Keff3(3.66D-12,-175.0_dp,0.0_dp,TEMP,0.027_dp))
  RCONST(260) = (Keff3(3.66D-12,-175.0_dp,0.0_dp,TEMP,0.768_dp))
  RCONST(261) = (2.0D-11)
  RCONST(262) = (Keff4(2.0D-11,den,nume))
  RCONST(263) = (Keff5(2.0D-11,den,nume))
  RCONST(264) = (Keff4(2.0D-11,den,nume))
  RCONST(265) = (Keff5(2.0D-11,den,nume))
  RCONST(266) = (Keff4(2.0D-11,den,nume))
  RCONST(267) = (Keff5(2.0D-11,den,nume))
  RCONST(268) = (Keff4(2.0D-11,den,nume))
  RCONST(269) = (Keff5(2.0D-11,den,nume))
  RCONST(270) = (Keff4(2.0D-11,den,nume))
  RCONST(271) = (Keff5(2.0D-11,den,nume))
  RCONST(272) = (Keff4(2.0D-11,den,nume))
  RCONST(273) = (Keff5(2.0D-11,den,nume))
  RCONST(274) = (Keff4(2.0D-11,den,nume))
  RCONST(275) = (Keff5(2.0D-11,den,nume))
  RCONST(276) = (Keff4(2.0D-11,den,nume))
  RCONST(277) = (Keff5(2.0D-11,den,nume))
  RCONST(278) = (Keff4(2.0D-11,den,nume))
  RCONST(279) = (Keff5(2.0D-11,den,nume))
  RCONST(280) = (Keff4(2.0D-11,den,nume))
  RCONST(281) = (Keff5(2.0D-11,den,nume))
  RCONST(282) = (Keff4(2.0D-11,den,nume))
  RCONST(283) = (Keff5(2.0D-11,den,nume))
  RCONST(284) = (Keff4(2.0D-11,den,nume))
  RCONST(285) = (Keff5(2.0D-11,den,nume))
  RCONST(286) = (Keff4(2.0D-11,den,nume))
  RCONST(287) = (Keff5(2.0D-11,den,nume))
  RCONST(288) = (7.16D-11)
  RCONST(289) = (6.3D-11)
END SUBROUTINE saprc99_mosaic_4bin_iepox_vbs_aq_Update_RCONST
...
END MODULE saprc99_mosaic_4bin_iepox_vbs_aq_UpdateRconstWRF
