 ...
 SUBROUTINE kpp_mechanism_driver(   &
    ...
    vdrog3, ldrog, vdrog3_vbs, ldrog_vbs, &
     ...
     USE module_kpp_saprc99_mosaic_12bin_vbs2_interf 
     USE module_kpp_saprc99_mosaic_20bin_vbs2_interf 
     USE module_kpp_saprc99_simplesom_mosaic_4bin_aq_interf 
     ...
     USE module_kpp_saprc99_mosaic_12bin_vbs2_aq_interf 
     ...
     USE module_kpp_saprc99_mosaic_8bin_vbs2_interf 
     USE module_kpp_saprc99_mosaic_4bin_vbs2_interf 
     USE module_kpp_saprc99_mosaic_4bin_iepox_vbs_aq_interf 
     ...
     USE module_kpp_saprc99_mosaic_20bin_vbs2_aq_interf 
  ...
  kpp_chem_select: SELECT CASE(config_flags%chem_opt)  
   ...
   CASE (saprc99_mosaic_12bin_vbs2_kpp) 
        ...
        CALL wrf_debug(15,'kpp_mechanism_driver: calling saprc99_mosaic_12bin_vbs2_interface') 

        CALL saprc99_mosaic_12bin_vbs2_interface(     &
   ...
   CASE (saprc99_mosaic_20bin_vbs2_kpp) 
        ...
        CALL wrf_debug(15,'kpp_mechanism_driver: calling saprc99_mosaic_20bin_vbs2_interface') 

        CALL saprc99_mosaic_20bin_vbs2_interface(     &
   ...
   CASE (saprc99_simplesom_mosaic_4bin_aq_kpp) 
        ...
        CALL wrf_debug(15,'kpp_mechanism_driver: calling saprc99_simplesom_mosaic_4bin_aq_interface') 

        CALL saprc99_simplesom_mosaic_4bin_aq_interface(     &
   ...
   CASE (saprc99_mosaic_12bin_vbs2_aq_kpp) 
        ...
        CALL wrf_debug(15,'kpp_mechanism_driver: calling saprc99_mosaic_12bin_vbs2_aq_interface') 

        CALL saprc99_mosaic_12bin_vbs2_aq_interface(     &
   ...
   CASE (saprc99_mosaic_8bin_vbs2_kpp) 
        ...
        CALL wrf_debug(15,'kpp_mechanism_driver: calling saprc99_mosaic_8bin_vbs2_interface') 

        CALL saprc99_mosaic_8bin_vbs2_interface(     &
   ...
   CASE (saprc99_mosaic_4bin_iepox_vbs_aq_kpp) 
        ...
        CALL wrf_debug(15,'kpp_mechanism_driver: calling saprc99_mosaic_4bin_iepox_vbs_aq_interface') 

        CALL saprc99_mosaic_4bin_iepox_vbs_aq_interface(     &
   ...
   CASE (saprc99_mosaic_20bin_vbs2_aq_kpp) 
        ...
        CALL wrf_debug(15,'kpp_mechanism_driver: calling saprc99_mosaic_20bin_vbs2_aq_interface') 

        CALL saprc99_mosaic_20bin_vbs2_aq_interface(     &
