   ...
   SUBROUTINE flow_dep_bdy_chem  (  chem,                                       &
      ...
      if ((ic .ge. p_so2) .and. (ic .le. p_ho2)) then
        ...
        if (config_flags%chem_opt == RACMPM_KPP ) then
          ...
          i_bdy_method = 4
      else if ((ic .ge. p_so4_a09) .and. (ic .le. p_num_a09)) then  
          i_bdy_method = 4
      else if ((ic .ge. p_so4_a10) .and. (ic .le. p_num_a10)) then
          i_bdy_method = 4
      else if ((ic .ge. p_so4_a11) .and. (ic .le. p_num_a11)) then
          i_bdy_method = 4
      else if ((ic .ge. p_so4_a12) .and. (ic .le. p_num_a12)) then
          i_bdy_method = 4
      else if ((ic .ge. p_so4_a13) .and. (ic .le. p_num_a13)) then
          i_bdy_method = 4
      else if ((ic .ge. p_so4_a14) .and. (ic .le. p_num_a14)) then
          i_bdy_method = 4
      else if ((ic .ge. p_so4_a15) .and. (ic .le. p_num_a15)) then
          i_bdy_method = 4
      else if ((ic .ge. p_so4_a16) .and. (ic .le. p_num_a16)) then
          i_bdy_method = 4
      else if ((ic .ge. p_so4_a17) .and. (ic .le. p_num_a17)) then
          i_bdy_method = 4
      else if ((ic .ge. p_so4_a18) .and. (ic .le. p_num_a18)) then
          i_bdy_method = 4
      else if ((ic .ge. p_so4_a19) .and. (ic .le. p_num_a19)) then
          i_bdy_method = 4
      else if ((ic .ge. p_so4_a20) .and. (ic .le. p_num_a20)) then
          i_bdy_method = 4
