...
MODULE saprc99_simplesom_mosaic_4bin_aq_UpdateRconstWRF
...
SUBROUTINE saprc99_simplesom_mosaic_4bin_aq_Update_RCONST(  &
...
REAL(KIND=dp), INTENT(IN) ::  nume,den
  ...
  RCONST(202) = (3.60D-11)
  RCONST(203) = (ARR(1.08D-15,821.0_dp,0.0_dp,TEMP))
  RCONST(204) = (ARR(3.66D-12,-175.0_dp,0.0_dp,TEMP))
  RCONST(205) = (3.27D-11)
  RCONST(206) = (6.80D-11)
  RCONST(207) = (6.21D-17)
  RCONST(208) = (8.29D-12)
  RCONST(209) = (3.27D-11)
  RCONST(210) = (ARR(1.37D-12,498.0_dp,2.0_dp,TEMP))
  RCONST(211) = (ARR(0.0_dp,0.0_dp,1.0_dp,TEMP))
  RCONST(212) = (ARR(9.40D-12,700.0_dp,0.0_dp,TEMP))
  RCONST(213) = (ARR(1.019D-11,434.0_dp,0.0_dp,TEMP))
  RCONST(214) = (ARR(5.946D-12,91.0_dp,0.0_dp,TEMP))
  RCONST(215) = (ARR(1.112D-11,52.0_dp,0.0_dp,TEMP))
  RCONST(216) = (ARR(1.81D-12,-355.0_dp,0.0_dp,TEMP))
  RCONST(217) = (2.640D-11)
  RCONST(218) = (ARR(7.095D-12,-451.0_dp,0.0_dp,TEMP))
  RCONST(219) = (ARR(2.617D-15,1640.0_dp,0.0_dp,TEMP))
  RCONST(220) = (ARR(4.453D-14,376.0_dp,0.0_dp,TEMP))
  RCONST(221) = (ARR(1.074D-11,234.0_dp,0.0_dp,TEMP))
  RCONST(222) = (ARR(1.743D-11,-384.0_dp,0.0_dp,TEMP))
  RCONST(223) = (ARR(5.022D-16,461.0_dp,0.0_dp,TEMP))
  RCONST(224) = (7.265D-13)
  RCONST(225) = (2.085D-11)
  RCONST(226) = (ARR(2.00D-14,4398.0_dp,0.0_dp,TEMP))
  RCONST(227) = (ARR(4.85D-12,-504.0_dp,0.0_dp,TEMP))
  RCONST(228) = (ARR(5.51D-15,1878.0_dp,0.0_dp,TEMP))
  RCONST(229) = (ARR(4.59D-13,1156.0_dp,0.0_dp,TEMP))
  RCONST(230) = (ARR(1.18D-11,324.0_dp,0.0_dp,TEMP))
  RCONST(231) = (ARR2(9.6e-12_dp,234.0_dp,TEMP))
  RCONST(232) = (usr24(TEMP,C_M))
  RCONST(233) = (ARR2(1.9e-13_dp,-520.0_dp,TEMP))
  RCONST(234) = (1.25D-11)
  RCONST(235) = (1.95D-11)
  RCONST(236) = (2.60D-11)
  RCONST(237) = (3.18D-11)
  ...
  RCONST(246) = (5.55D-11)
  RCONST(247) = (5.23D-11)
END SUBROUTINE saprc99_simplesom_mosaic_4bin_aq_Update_RCONST
...
END MODULE saprc99_simplesom_mosaic_4bin_aq_UpdateRconstWRF
