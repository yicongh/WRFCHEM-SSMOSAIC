	...
	integer, parameter :: maxd_asize = 20  
	...
	real, parameter :: dens_bc_aer  = 1.70
        ...
        real, parameter :: dens_cldiepoxos_aer = 1.0
        real, parameter :: dens_cldtetrol_aer = 1.0
	...
	real, parameter :: dens_terp_Cn3_aer = 1.0
	...
	real, parameter :: mw_water_aer  = 18.016
        ...
        real, parameter :: mw_cldiepoxos_aer = 216.0
        real, parameter :: mw_cldtetrol_aer = 136.0
	...
	real, parameter :: mw_terp_Cn3_aer = 250.0
	...
	real, parameter :: hygro_bc_aer  = 1.e-6
        ...
        real, parameter :: hygro_smpbb_aer = 0.140
         ...
         real, parameter :: hygro_cldiepoxos_aer  = 0.10
         real, parameter :: hygro_cldtetrol_aer  = 0.10
	...
	real, parameter :: hygro_terp_Cn3_aer = 0.10
	...
	integer, save :: mastercompindx_bc_aer  = -999888777
       ...
       integer, save :: mastercompindx_iepox_aer = -999888777
        ...
        integer, save :: mastercompindx_cldiepoxos_aer = -999888777
        integer, save :: mastercompindx_cldtetrol_aer = -999888777
	...
	integer, save :: mastercompindx_terp_Cn3_aer = -999888777
	...
	integer, save ::                     &
          ...
          lptr_cldiepoxos_aer(maxd_asize, maxd_atype, maxd_aphase),    &
          lptr_cldtetrol_aer(maxd_asize, maxd_atype, maxd_aphase),    &
	  ...
	  lptr_terp_Cn3_aer(maxd_asize, maxd_atype, maxd_aphase),    &
