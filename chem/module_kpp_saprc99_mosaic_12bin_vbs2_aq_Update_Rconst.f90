...
MODULE saprc99_mosaic_12bin_vbs2_aq_UpdateRconstWRF
...
SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_Update_RCONST(  &
...
REAL(KIND=dp), INTENT(IN) ::  nume,den
  ...
  RCONST(257) = (ARR2(9.6e-12_dp,234._dp,TEMP))
  RCONST(258) = (usr24(temp,c_m))
  RCONST(259) = (ARR2(1.9e-13_dp,-520._dp,TEMP))
END SUBROUTINE saprc99_mosaic_12bin_vbs2_aq_Update_RCONST
...
END MODULE saprc99_mosaic_12bin_vbs2_aq_UpdateRconstWRF
